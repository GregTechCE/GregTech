...
public class RecipeMaps {
    ...
    @ZenProperty public static final RecipeMap<SimpleRecipeBuilder> MACERATOR_RECIPES = new RecipeMap<>("macerator", 1, 1, 1, 4, 0, 0, 0, 0, 1, new SimpleRecipeBuilder().duration(150).EUt(8))
