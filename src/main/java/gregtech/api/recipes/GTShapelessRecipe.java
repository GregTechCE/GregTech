...
public class GTShapelessRecipe extends ShapelessOreRecipe implements IRemovableRecipe {
    ...
    public GTShapelessRecipe(ItemStack result, boolean dismantleAble, boolean removableByGT, boolean keepingNBT, Enchantment[] enchantmentsAdded, int[] enchantmentLevelsAdded, Object... recipe) {
        super(result, recipe);
