...
public class GT_MetaPipeEntity_Frame extends MetaPipeEntity {
    ...
    public GT_MetaPipeEntity_Frame(int aID, String aName, String aNameRegional, Materials aMaterial) {
        ...
        OreDictionaryUnifier.registerOre(OrePrefixes.frameGt, aMaterial, getStackForm(1));
        ...
        RA.addAssemblerRecipe(OreDictionaryUnifier.get(OrePrefixes.stick, aMaterial, 4), ItemList.Circuit_Integrated.getWithDamage(0, 4), getStackForm(1), 64, 8);
    }
