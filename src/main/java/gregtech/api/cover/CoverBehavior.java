...
public abstract class CoverBehavior implements IUIHolder {
    ...
    public boolean onLeftClick(EntityPlayer entityPlayer, float hitX, float hitY, float hitZ) {
        return false;
    }

    public EnumActionResult onRightClick(EntityPlayer playerIn, EnumHand hand, float hitX, float hitY, float hitZ) {
