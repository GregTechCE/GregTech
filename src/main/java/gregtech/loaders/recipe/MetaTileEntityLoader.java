...
public class MetaTileEntityLoader {
    ...
    public static void init() {
        ...
        RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .outputs(MetaBlocks.MULTIBLOCK_CASING.getItemVariant(ASSEMBLY_LINE_CASING, 2))
        ...
        ModHandler.addShapedRecipe("casing_uhv", MetaBlocks.MACHINE_CASING.getItemVariant(UHV), "PPP", "PwP", "PPP", 'P', new UnificationEntry(OrePrefix.plate, Materials.Darmstadtium));
        ...
        if (ConfigHolder.harderMachineHulls) {
            ...
            ModHandler.addShapedRecipe("hull_uhv", MetaTileEntities.HULL[GTValues.UHV].getStackForm(), "PHP", "CMC", 'M', MetaBlocks.MACHINE_CASING.getItemVariant(UHV), 'C', new UnificationEntry(OrePrefix.wireGtSingle, MarkerMaterials.Tier.Superconductor), 'H', new UnificationEntry(OrePrefix.plate, Materials.Darmstadtium), 'P', new UnificationEntry(OrePrefix.plate, Materials.Polytetrafluoroethylene));
        } else {
            ...
            ModHandler.addShapedRecipe("hull_uhv", MetaTileEntities.HULL[GTValues.UHV].getStackForm(), "CMC", 'M', MetaBlocks.MACHINE_CASING.getItemVariant(UHV), 'C', new UnificationEntry(OrePrefix.wireGtSingle, MarkerMaterials.Tier.Superconductor));
        }
        ...
        ModHandler.addShapedRecipe("transformer_zpm", MetaTileEntities.TRANSFORMER[GTValues.ZPM - 1].getStackForm(), "KBB", "CM ", "KBB", 'M', MetaTileEntities.HULL[GTValues.LuV].getStackForm(), 'C', new UnificationEntry(OrePrefix.cableGtSingle, Materials.Naquadah), 'B', new UnificationEntry(OrePrefix.cableGtSingle, Materials.VanadiumGallium), 'K', new UnificationEntry(OrePrefix.circuit, Tier.Extreme));
        ModHandler.addShapedRecipe("transformer_uv", MetaTileEntities.TRANSFORMER[GTValues.UV - 1].getStackForm(), "KBB", "CM ", "KBB", 'M', MetaTileEntities.HULL[GTValues.ZPM].getStackForm(), 'C', new UnificationEntry(OrePrefix.wireGtQuadruple, Materials.NaquadahAlloy), 'B', new UnificationEntry(OrePrefix.cableGtSingle, Materials.Naquadah), 'K', new UnificationEntry(OrePrefix.circuit, Tier.Elite));
        ...
        ModHandler.addShapedRecipe("energy_output_hatch_uhv", MetaTileEntities.ENERGY_OUTPUT_HATCH[GTValues.UHV].getStackForm(), " MC", 'M', MetaTileEntities.HULL[GTValues.UHV].getStackForm(), 'C', new UnificationEntry(OrePrefix.wireGtSingle, MarkerMaterials.Tier.Superconductor));
        ...
        ModHandler.addShapedRecipe("energy_input_hatch_max", MetaTileEntities.ENERGY_INPUT_HATCH[GTValues.UHV].getStackForm(), "CM ", 'M', MetaTileEntities.HULL[GTValues.UHV].getStackForm(), 'C', new UnificationEntry(OrePrefix.wireGtSingle, MarkerMaterials.Tier.Superconductor));
        ...
        ModHandler.addShapedRecipe("fluid_import_hatch_uhv", MetaTileEntities.FLUID_IMPORT_HATCH[GTValues.UHV].getStackForm(), "G", "M", 'M', MetaTileEntities.HULL[GTValues.UHV].getStackForm(), 'G', new ItemStack(Blocks.GLASS));
        ...
        ModHandler.addShapedRecipe("fluid_export_hatch_uhv", MetaTileEntities.FLUID_EXPORT_HATCH[GTValues.UHV].getStackForm(), "M", "G", 'M', MetaTileEntities.HULL[GTValues.UHV].getStackForm(), 'G', new ItemStack(Blocks.GLASS));
        ...
        ModHandler.addShapedRecipe("item_import_bus_uhv", MetaTileEntities.ITEM_IMPORT_BUS[GTValues.UHV].getStackForm(), "C", "M", 'M', MetaTileEntities.HULL[GTValues.UHV].getStackForm(), 'C', OreDictNames.chestWood);
        ...
        ModHandler.addShapedRecipe("item_export_bus_uhv", MetaTileEntities.ITEM_EXPORT_BUS[GTValues.UHV].getStackForm(), "M", "C", 'M', MetaTileEntities.HULL[GTValues.UHV].getStackForm(), 'C', OreDictNames.chestWood);
        ...
        ModHandler.addShapedRecipe("battery_buffer_uhv_1x1", MetaTileEntities.BATTERY_BUFFER[GTValues.UHV][0].getStackForm(), "WTW", "WMW", 'M', MetaTileEntities.HULL[GTValues.UHV].getStackForm(), 'W', new UnificationEntry(OrePrefix.wireGtSingle, MarkerMaterials.Tier.Superconductor), 'T', OreDictNames.chestWood);
        ...
        ModHandler.addShapedRecipe("battery_buffer_uhv_2x2", MetaTileEntities.BATTERY_BUFFER[GTValues.UHV][1].getStackForm(), "WTW", "WMW", 'M', MetaTileEntities.HULL[GTValues.UHV].getStackForm(), 'W', new UnificationEntry(OrePrefix.wireGtQuadruple, MarkerMaterials.Tier.Superconductor), 'T', OreDictNames.chestWood);
        ...
        ModHandler.addShapedRecipe("battery_buffer_uhv_3x3", MetaTileEntities.BATTERY_BUFFER[GTValues.UHV][2].getStackForm(), "WTW", "WMW", 'M', MetaTileEntities.HULL[GTValues.UHV].getStackForm(), 'W', new UnificationEntry(OrePrefix.wireGtOctal, MarkerMaterials.Tier.Superconductor), 'T', OreDictNames.chestWood);
        ...
        ModHandler.addShapedRecipe("battery_buffer_uhv_4x4", MetaTileEntities.BATTERY_BUFFER[GTValues.UHV][3].getStackForm(), "WTW", "WMW", 'M', MetaTileEntities.HULL[GTValues.UHV].getStackForm(), 'W', new UnificationEntry(OrePrefix.wireGtHex, MarkerMaterials.Tier.Superconductor), 'T', OreDictNames.chestWood);
        ...
        ModHandler.addShapedRecipe("charger_uhv", MetaTileEntities.CHARGER[GTValues.UHV].getStackForm(), "WTW", "WMW", "BCB", 'M', MetaTileEntities.HULL[GTValues.UHV].getStackForm(), 'W', new UnificationEntry(OrePrefix.wireGtHex, MarkerMaterials.Tier.Superconductor), 'T', OreDictNames.chestWood, 'B', MetaItems.ZPM2, 'C', new UnificationEntry(OrePrefix.circuit, MarkerMaterials.Tier.Infinite));
        ...
        ModHandler.addShapedRecipe("rotor_holder_uhv", MetaTileEntities.ROTOR_HOLDER[2].getStackForm(), "WHW", "WRW", "WWW", 'H', MetaTileEntities.HULL[GTValues.UHV].getStackForm(), 'W', new UnificationEntry(OrePrefix.wireGtHex, Tier.Superconductor), 'R', new UnificationEntry(OrePrefix.gear, Materials.HSSS));
        ...
        ModHandler.addShapedRecipe("cracking_unit", MetaTileEntities.CRACKER.getStackForm(), "CEC", "PHP", "CEC", 'C', MetaBlocks.WIRE_COIL.getItemVariant(CUPRONICKEL), 'E', MetaItems.ELECTRIC_PUMP_HV, 'P', new UnificationEntry(OrePrefix.circuit, Tier.Extreme), 'H', MetaTileEntities.HULL[GTValues.HV].getStackForm());
...
//        ModHandler.addShapedRecipe(MetaTileEntities.MACHINE_MULTI_ASSEMBLYLINE.get(1L, new Object[0]), new Object[]{"WCW", "EME", "WCW", 'M', MetaTileEntities.HULL[GTValues.IV].getStackForm(), 'W', MetaTileEntities.Casing_Assembler, 'E', new UnificationEntry(OrePrefix.circuit, MarkerMaterials.Tier.Elite), 'C', MetaItems.ROBOT_ARM_IV});
    ...
    public static <T extends MetaTileEntity & ITieredMetaTileEntity> void registerMachineRecipe(T[] metaTileEntities, Object... recipe) {
        for (T metaTileEntity : metaTileEntities) {
            if (metaTileEntity != null) { // Needed to skip certain tiers if not enabled
