...
public class MachineRecipeLoader {
    ...
    private static void registerAssemblerRecipes() {
        ...
        RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(200).EUt(1).input(OrePrefix.circuit, Tier.Primitive).input(OrePrefix.cableGtSingle, Materials.RedAlloy, 2).fluidInputs(Materials.Glue.getFluid(125)).outputs(MetaItems.CHARGER_CONTROL_CIRCUIT_ULV.getStackForm()).buildAndRegister();
        RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(800).EUt(1).input(OrePrefix.circuit, Tier.Basic).input(OrePrefix.cableGtSingle, Materials.Tin, 2).fluidInputs(Materials.SolderingAlloy.getFluid(144)).outputs(MetaItems.CHARGER_CONTROL_CIRCUIT_LV.getStackForm()).buildAndRegister();
        RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(1600).EUt(2).input(OrePrefix.circuit, Tier.Good).input(OrePrefix.cableGtSingle, Materials.Copper, 2).fluidInputs(Materials.SolderingAlloy.getFluid(144)).outputs(MetaItems.CHARGER_CONTROL_CIRCUIT_MV.getStackForm()).buildAndRegister();
        RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(3200).EUt(4).input(OrePrefix.circuit, Tier.Advanced).input(OrePrefix.cableGtSingle, Materials.Gold, 2).fluidInputs(Materials.SolderingAlloy.getFluid(144)).outputs(MetaItems.CHARGER_CONTROL_CIRCUIT_HV.getStackForm()).buildAndRegister();
