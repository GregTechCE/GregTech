...
public class BatteryRecipes {
    ...
    public static void init() {
        ...
        RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(30).EUt(4)
                ...
                .outputs(MetaItems.BATTERY_ULV_TANTALUM.getStackForm(8))
                .buildAndRegister();

        RecipeMaps.EXTRACTOR_RECIPES.recipeBuilder()
                .inputs(BATTERY_LV_CADMIUM.getStackForm())
                .outputs(BATTERY_HULL_LV.getStackForm())
                .buildAndRegister();

        RecipeMaps.EXTRACTOR_RECIPES.recipeBuilder()
                .inputs(BATTERY_LV_LITHIUM.getStackForm())
                .outputs(BATTERY_HULL_LV.getStackForm())
                .buildAndRegister();

        RecipeMaps.EXTRACTOR_RECIPES.recipeBuilder()
                .inputs(BATTERY_LV_SODIUM.getStackForm())
                .outputs(BATTERY_HULL_LV.getStackForm())
                .buildAndRegister();

        RecipeMaps.EXTRACTOR_RECIPES.recipeBuilder()
                .inputs(BATTERY_MV_CADMIUM.getStackForm())
                .outputs(BATTERY_HULL_MV.getStackForm())
                .buildAndRegister();

        RecipeMaps.EXTRACTOR_RECIPES.recipeBuilder()
                .inputs(BATTERY_MV_LITHIUM.getStackForm())
                .outputs(BATTERY_HULL_MV.getStackForm())
                .buildAndRegister();

        RecipeMaps.EXTRACTOR_RECIPES.recipeBuilder()
                .inputs(BATTERY_MV_SODIUM.getStackForm())
                .outputs(BATTERY_HULL_MV.getStackForm())
                .buildAndRegister();
        ...
        RecipeMaps.EXTRACTOR_RECIPES.recipeBuilder()
                .inputs(BATTERY_HV_SODIUM.getStackForm())
                .outputs(BATTERY_HULL_HV.getStackForm())
                .buildAndRegister();
        ...
        RecipeMaps.CANNER_RECIPES.recipeBuilder()
                ...
                .outputs(BATTERY_LV_CADMIUM.getStackForm())
                .duration(100).EUt(2)
                .buildAndRegister();
        ...
        RecipeMaps.CANNER_RECIPES.recipeBuilder()
                ...
                .outputs(BATTERY_LV_LITHIUM.getStackForm())
                .duration(100).EUt(2)
                .buildAndRegister();
        ...
        RecipeMaps.CANNER_RECIPES.recipeBuilder()
                ...
                .outputs(BATTERY_LV_SODIUM.getStackForm())
                .duration(100).EUt(2)
                .buildAndRegister();
        ...
        RecipeMaps.CANNER_RECIPES.recipeBuilder()
                ...
                .outputs(BATTERY_MV_CADMIUM.getStackForm())
                .duration(400).EUt(2)
                .buildAndRegister();
        ...
        RecipeMaps.CANNER_RECIPES.recipeBuilder()
                ...
                .outputs(BATTERY_MV_LITHIUM.getStackForm())
                .duration(400).EUt(2)
                .buildAndRegister();
        ...
        RecipeMaps.CANNER_RECIPES.recipeBuilder()
                ...
                .outputs(BATTERY_MV_SODIUM.getStackForm())
                .duration(400).EUt(2)
                .buildAndRegister();
        ...
        RecipeMaps.CANNER_RECIPES.recipeBuilder()
                ...
                .outputs(BATTERY_HV_CADMIUM.getStackForm())
                .duration(1600).EUt(2)
                .buildAndRegister();
        ...
        RecipeMaps.CANNER_RECIPES.recipeBuilder()
                ...
                .outputs(BATTERY_HV_LITHIUM.getStackForm())
                .duration(1600).EUt(2)
                .buildAndRegister();
        ...
        RecipeMaps.CANNER_RECIPES.recipeBuilder()
                ...
                .outputs(BATTERY_HV_SODIUM.getStackForm())
                .duration(1600).EUt(2)
                .buildAndRegister();
    }
}
