...
public class GT_CropLoader
    ...
    public void run() {
        ...
        try {
            ...
            new GT_BaseCrop(128, "Diareed", "Direwolf20", 			null, 12, 4,    0, 1, 4, 5, 0,10, 2,10, new String[]{"Fire", "Shiny", "Reed", "Coal", "Diamond", "Crystal"}, Materials.Diamond, OreDictionaryUnifier.get(OrePrefixes.dustTiny, Materials.Diamond, 1L), new ItemStack[]{new ItemStack(Items.DIAMOND, 1)});
            new GT_BaseCrop(129, "Withereed", "CovertJaguar", 		null,  8, 4,    0, 1, 4, 2, 0, 4, 1, 3, new String[]{"Fire", "Undead", "Reed", "Coal", "Rotten", "Wither"}, Materials.Coal, OreDictionaryUnifier.get(OrePrefixes.dust, Materials.Coal, 1L), new ItemStack[]{new ItemStack(Items.COAL, 1), new ItemStack(Items.COAL, 1)});
            ...
            new GT_BaseCrop(134, "Creeperweed", "General Spaz", 	null,  7, 4,    0, 1, 4, 3, 0, 5, 1, 3, new String[]{"Creeper", "Vine", "Explosive", "Fire", "Sulfur", "Saltpeter", "Coal"}, OreDictionaryUnifier.get(OrePrefixes.dust, Materials.Gunpowder, 1L), null);
            new GT_BaseCrop(135, "Enderbloom", "RichardG", 			null, 10, 4,    0, 1, 4, 5, 0, 2, 1, 6, new String[]{"Ender", "Flower", "Shiny"}, 										OreDictionaryUnifier.get(OrePrefixes.dust, Materials.EnderPearl, 1L), new ItemStack[]{new ItemStack(Items.ENDER_PEARL, 1), new ItemStack(Items.ENDER_PEARL, 1), new ItemStack(Items.ENDER_EYE, 1)});
            ...
            new GT_BaseCrop(147, "Steeleafranks", "Benimatic", 		null, 10, 4,    0, 1, 4, 3, 0, 7, 2, 8, new String[]{"Metal", "Vine", "Iron"}, 											OreDictionaryUnifier.get(OrePrefixes.dust, Materials.Steeleaf, 1L), new ItemStack[]{OreDictionaryUnifier.get(OrePrefixes.ingot, Materials.Steeleaf, 1L)});
            new GT_BaseCrop(148, "Liveroots", "Benimatic", 			null,  8, 4,    0, 1, 4, 2, 0, 5, 2, 6, new String[]{"Wood", "Vine"}, 													OreDictionaryUnifier.get(OrePrefixes.dust, Materials.LiveRoot, 1L), new ItemStack[]{ItemList.TF_LiveRoot.get(1L)});

            new GT_BaseCrop(149, "Trollplant", "unknown", 			null,  6, 5, 1000, 1, 4, 0, 0, 5, 2, 8, new String[]{"Troll", "Bad", "Scrap"}, 											OreDictionaryUnifier.get(OrePrefixes.gem, Materials.FoolsRuby, 1L), new ItemStack[]{ItemList.IC2_Plantball.get(1), ItemList.IC2_Scrap.get(1), OreDictionaryUnifier.get(OrePrefixes.dustTiny, Materials.Plutonium241, 1L)});
            new GT_BaseCrop(150, "Lazulia", "unknown", 				null,  7, 4,    0, 2, 4, 4, 2, 5, 7, 4, new String[]{"Shiny", "Bad", "Crystal", "Lapis"}, Materials.Lapis, 				OreDictionaryUnifier.get(OrePrefixes.dustTiny, Materials.Lapis, 1L), null);
            new GT_BaseCrop(151, "Glowheat", "unknown", 			null, 10, 7,    0, 5, 7, 3, 3, 3, 5, 4, new String[]{"Light", "Shiny", "Crystal"}, 										OreDictionaryUnifier.get(OrePrefixes.dustTiny, Materials.Glowstone, 1L), null);
            new GT_BaseCrop(153, "Fertilia", "unknown", 			null,  3, 4,    0, 1, 4, 2, 3, 5, 4, 8, new String[]{"Growth", "Healing", "Flower"}, 									OreDictionaryUnifier.get(OrePrefixes.dustTiny, Materials.Calcite, 1L), new ItemStack[]{ItemList.IC2_Fertilizer.get(1), OreDictionaryUnifier.get(OrePrefixes.dustTiny, Materials.Apatite, 1L), OreDictionaryUnifier.get(OrePrefixes.dust, Materials.Phosphate, 1L)});
            ...
            new GT_BaseCrop(157, "God of Thunder", "unknown", 		null,  9, 4,    0, 2, 4, 3, 0, 5, 1, 2, new String[]{"Radioactive", "Metal", "Coal", "Thorium"}, Materials.Thorium, 	OreDictionaryUnifier.get(OrePrefixes.dustSmall, Materials.Coal, 1L), new ItemStack[]{OreDictionaryUnifier.get(OrePrefixes.gem, Materials.Coal, 1L), ItemList.Crop_Drop_Thorium.get(1)});
            ...
            new GT_BaseCrop(159, "Starwart", "unknown", 			null, 12, 4, 4000, 1, 4, 2, 0, 0, 1, 0, new String[]{"Wither", "Nether", "Undead", "Netherstar"}, Materials.NetherStar, OreDictionaryUnifier.get(OrePrefixes.dustSmall, Materials.Coal, 1L), new ItemStack[]{OreDictionaryUnifier.get(OrePrefixes.gem, Materials.Coal, 1L), new ItemStack(Items.SKULL, 1), new ItemStack(Items.SKULL, 1, 1), new ItemStack(Items.SKULL, 1, 1), OreDictionaryUnifier.get(OrePrefixes.dustTiny, Materials.NetherStar, 1L)});
            ...
            new GT_BaseCrop(163, "Evil Ore", "unknown", 			null,  8, 4,    0, 3, 4, 4, 0, 2, 1, 3, new String[]{"Crystal", "Fire", "Nether"}, 										OreDictionaryUnifier.get(OrePrefixes.dustTiny, Materials.NetherQuartz, 1L), new ItemStack[]{OreDictionaryUnifier.get(OrePrefixes.gem, Materials.NetherQuartz, 1L), OreDictionaryUnifier.get(OrePrefixes.dustTiny, Materials.CertusQuartz, 1L),});
            new GT_BaseCrop(164, "Olivia", "unknown", 				null,  2, 4,    0, 3, 4, 1, 0, 1, 4, 0, new String[]{"Crystal", "Shiny", "Processing", "Olivine"}, Materials.Olivine, 	OreDictionaryUnifier.get(OrePrefixes.dustTiny, Materials.Olivine, 1L), new ItemStack[]{OreDictionaryUnifier.get(OrePrefixes.gem, Materials.Olivine, 1L),});
            new GT_BaseCrop(165, "Sapphirum", "unknown", 			null,  4, 4,    0, 3, 4, 1, 0, 1, 5, 0, new String[]{"Crystal", "Shiny", "Metal", "Sapphire"}, Materials.Sapphire, 		OreDictionaryUnifier.get(OrePrefixes.dustTiny, Materials.Sapphire, 1L), new ItemStack[]{OreDictionaryUnifier.get(OrePrefixes.gem, Materials.Sapphire, 1L),});
            ...
            new GT_BaseCrop(170, "Stargatium", "unknown", 			null, 12, 4, 1500, 1, 4, 4, 0, 0, 2, 0, new String[]{"Metal", "Heavy", "Alien", "Naquadah"}, Materials.Naquadah, 		OreDictionaryUnifier.get(OrePrefixes.dustTiny, Materials.Endstone, 1L), new ItemStack[]{ItemList.Crop_Drop_Naquadah.get(1, new Object[0])});
