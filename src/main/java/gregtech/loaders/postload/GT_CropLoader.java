...
//      					Name			Finder						Main Drop																SecDrop	Seed														Tier 	Size	Speed	aHarves	Harvest	Chem	Food	Def		Color	Weed	Attributes
            ...
            new GT_BaseCrop(154, "Bauxia", "unknown", ItemList.Crop_Drop_Bauxite.get(1, new Object[0]), null, null, 6, 3, 0, 2, 3, 2, 0, 5, 2, 6, new String[]{"Metal", "Aluminium", "Reed", "Aluminium"}, Materials.Aluminium);
            new GT_BaseCrop(155, "Titania", "unknown", ItemList.Crop_Drop_Ilmenite.get(1, new Object[0]), null, null, 9, 3, 0, 2, 3, 2, 0, 5, 2, 6, new String[]{"Metal", "Heavy", "Reed", "Titanium"}, Materials.Titanium);
            new GT_BaseCrop(156, "Reactoria", "unknown", ItemList.Crop_Drop_Pitchblende.get(1, new Object[0]), new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Uraninite, 1L)}, null, 12, 4, 0, 2, 4, 2, 0, 5, 2, 6, new String[]{"Radioactive", "Metal", "Danger", "Uranium"}, Materials.Uranium);
            new GT_BaseCrop(157, "God of Thunder", "unknown", GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Coal, 1L), new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Coal, 1L), ItemList.Crop_Drop_Thorium.get(1, new Object[0])}, null, 9, 4, 0, 2, 4, 2, 0, 5, 2, 6, new String[]{"Radioactive", "Metal", "Coal", "Thorium"}, Materials.Thorium);
            ...
            new GT_BaseCrop(161, "Nickelback", "unknown", ItemList.Crop_Drop_Nickel.get(1, new Object[0]), null, null, 5, 3, 0, 2, 3, 2, 0, 5, 2, 6, new String[]{"Metal", "Fire", "Alloy"}, Materials.Nickel);
            new GT_BaseCrop(162, "Galvania", "unknown", ItemList.Crop_Drop_Zinc.get(1, new Object[0]), null, null, 6, 3, 0, 2, 3, 2, 0, 5, 2, 6, new String[]{"Metal", "Alloy", "Bush"}, Materials.Zinc);
            ...
            new GT_BaseCrop(166, "Pyrolusium", "unknown", ItemList.Crop_Drop_Manganese.get(1, new Object[0]), null, null, 12, 3, 0, 2, 3, 2, 0, 5, 2, 6, new String[]{"Metal", "Clean", "Bush", "Manganese"}, Materials.Manganese);
            new GT_BaseCrop(167, "Scheelinium", "unknown", ItemList.Crop_Drop_Scheelite.get(1, new Object[0]), null, null, 12, 3, 0, 2, 3, 2, 0, 5, 2, 6, new String[]{"Metal", "Hard", "Bush", "Tungsten"}, Materials.Tungsten);
            new GT_BaseCrop(168, "Platina", "unknown", ItemList.Crop_Drop_Platinum.get(1, new Object[0]), null, null, 11, 4, 0, 1, 4, 2, 0, 5, 2, 6, new String[]{"Metal", "Shiny", "Reed", "Platinum"}, Materials.Platinum);
            new GT_BaseCrop(169, "Quantaria", "unknown", ItemList.Crop_Drop_Iridium.get(1, new Object[0]), new ItemStack[]{ItemList.Crop_Drop_Osmium.get(1, new Object[0])}, null, 12, 4, 1000, 1, 4, 2, 0, 5, 2, 6, new String[]{"Metal", "Iridium", "Reed", "Iridium"}, Materials.Iridium);
            new GT_BaseCrop(170, "Stargatium", "unknown", GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Endstone, 1L), new ItemStack[]{ItemList.Crop_Drop_Naquadah.get(1, new Object[0])}, null, 12, 4, 1500, 1, 4, 2, 0, 5, 2, 6, new String[]{"Metal", "Heavy", "Alien", "Naquadah"}, Materials.Naquadah);
        } catch (Throwable e) {
