...
public class GT_CraftingRecipeLoader implements Runnable {
        ...
        public void run() {
                ...
                if (tStack != null) {
                        GT_ModHandler.addCraftingRecipe(GTUtility.copyAmount(GregTechMod.gregtechproxy.mNerfedWoodPlank ? tStack.stackSize : tStack.stackSize * 5 / 4, new Object[]{tStack}), GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.BUFFERED, new Object[]{"s", "P", "P", 'P', OrePrefix.plank.get(Materials.Wood)});
                        GT_ModHandler.addCraftingRecipe(GTUtility.copyAmount(GregTechMod.gregtechproxy.mNerfedWoodPlank ? tStack.stackSize / 2 : tStack.stackSize, new Object[]{tStack}), GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.BUFFERED, new Object[]{"P", "P", 'P', OrePrefix.plank.get(Materials.Wood)});
                }
                ...
                GT_ModHandler.addCraftingRecipe(OreDictUnifier.get(OrePrefix.ring, Materials.Rubber, 1), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{"k", "X", 'X', OrePrefix.plate.get(Materials.Rubber)});
                GT_ModHandler.addCraftingRecipe(OreDictUnifier.get(OrePrefix.toolHeadArrow, Materials.Flint, 1), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{"f", "X", 'X', new ItemStack(Items.FLINT, 1, 32767)});
                ...
                GT_ModHandler.removeRecipe(new ItemStack[]{OreDictUnifier.get(OrePrefix.ingot, Materials.Copper, 1), OreDictUnifier.get(OrePrefix.ingot, Materials.Tin, 1), OreDictUnifier.get(OrePrefix.ingot, Materials.Copper, 1)});
                if (null != GTUtility.setStack(GT_ModHandler.getRecipeOutput(true, new ItemStack[]{OreDictUnifier.get(OrePrefix.ingot, Materials.Copper, 1), OreDictUnifier.get(OrePrefix.ingot, Materials.Copper, 1), null, OreDictUnifier.get(OrePrefix.ingot, Materials.Copper, 1), OreDictUnifier.get(OrePrefix.ingot, Materials.Tin, 1)}), OreDictUnifier.get(OrePrefix.ingot, Materials.Bronze, GregTechAPI.sRecipeFile.get(ConfigCategories.Recipes.disabledrecipes, "bronzeingotcrafting", true) ? 1 : 2L))) {
                ...
                GT_ModHandler.addCraftingRecipe(GT_ModHandler.getRecipeOutput(new ItemStack[]{tStack, tStack, tStack, tStack, OreDictUnifier.get(OrePrefix.gem, Materials.Apatite, 1), tStack, tStack, tStack, tStack}), new Object[]{"SSS", "SAS", "SSS", 'A', OrePrefix.dust.get(Materials.Apatite), 'S', OrePrefix.dust.get(Materials.Ash)});
                ...
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.stick, Materials.IronMagnetic, 1), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.stick.get(Materials.AnyIron), OrePrefix.dust.get(Materials.Redstone), OrePrefix.dust.get(Materials.Redstone), OrePrefix.dust.get(Materials.Redstone), OrePrefix.dust.get(Materials.Redstone)});
                ...
                if (!Materials.Steel.mBlastFurnaceRequired) {
                        GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.Steel, 1), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Iron), OrePrefix.dust.get(Materials.Coal), OrePrefix.dust.get(Materials.Coal)});
                }
                if (GregTechMod.gregtechproxy.mNerfDustCrafting) {
                        GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dustSmall, Materials.Electrum, 6L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Silver), OrePrefix.dust.get(Materials.Gold)});
                        GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.Brass, 3L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.AnyCopper), OrePrefix.dust.get(Materials.AnyCopper), OrePrefix.dust.get(Materials.AnyCopper), OrePrefix.dust.get(Materials.Zinc)});
                        GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dustSmall, Materials.Brass, 9L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Tetrahedrite), OrePrefix.dust.get(Materials.Tetrahedrite), OrePrefix.dust.get(Materials.Tetrahedrite), OrePrefix.dust.get(Materials.Zinc)});
                        GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.Bronze, 3L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.AnyCopper), OrePrefix.dust.get(Materials.AnyCopper), OrePrefix.dust.get(Materials.AnyCopper), OrePrefix.dust.get(Materials.Tin)});
                        GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dustSmall, Materials.Bronze, 9L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Tetrahedrite), OrePrefix.dust.get(Materials.Tetrahedrite), OrePrefix.dust.get(Materials.Tetrahedrite), OrePrefix.dust.get(Materials.Tin)});
                        GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dustSmall, Materials.Invar, 9L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Iron), OrePrefix.dust.get(Materials.Iron), OrePrefix.dust.get(Materials.Nickel)});
                        GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dustSmall, Materials.Cupronickel, 6L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Nickel), OrePrefix.dust.get(Materials.AnyCopper)});
                        GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dustSmall, Materials.Nichrome, 15L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Nickel), OrePrefix.dust.get(Materials.Nickel), OrePrefix.dust.get(Materials.Nickel), OrePrefix.dust.get(Materials.Nickel), OrePrefix.dust.get(Materials.Chrome)});
                } else {
                        GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.Electrum, 2L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Silver), OrePrefix.dust.get(Materials.Gold)});
                        GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.Brass, 4L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.AnyCopper), OrePrefix.dust.get(Materials.AnyCopper), OrePrefix.dust.get(Materials.AnyCopper), OrePrefix.dust.get(Materials.Zinc)});
                        GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.Brass, 3L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Tetrahedrite), OrePrefix.dust.get(Materials.Tetrahedrite), OrePrefix.dust.get(Materials.Tetrahedrite), OrePrefix.dust.get(Materials.Zinc)});
                        GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.Bronze, 4L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.AnyCopper), OrePrefix.dust.get(Materials.AnyCopper), OrePrefix.dust.get(Materials.AnyCopper), OrePrefix.dust.get(Materials.Tin)});
                        GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.Bronze, 3L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Tetrahedrite), OrePrefix.dust.get(Materials.Tetrahedrite), OrePrefix.dust.get(Materials.Tetrahedrite), OrePrefix.dust.get(Materials.Tin)});
                        GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.Invar, 3L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Iron), OrePrefix.dust.get(Materials.Iron), OrePrefix.dust.get(Materials.Nickel)});
                        GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.Cupronickel, 2L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Nickel), OrePrefix.dust.get(Materials.AnyCopper)});
                        GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.Nichrome, 5L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Nickel), OrePrefix.dust.get(Materials.Nickel), OrePrefix.dust.get(Materials.Nickel), OrePrefix.dust.get(Materials.Nickel), OrePrefix.dust.get(Materials.Chrome)});
                }
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.RoseGold, 5L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Gold), OrePrefix.dust.get(Materials.Gold), OrePrefix.dust.get(Materials.Gold), OrePrefix.dust.get(Materials.Gold), OrePrefix.dust.get(Materials.AnyCopper)});
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.SterlingSilver, 5L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Silver), OrePrefix.dust.get(Materials.Silver), OrePrefix.dust.get(Materials.Silver), OrePrefix.dust.get(Materials.Silver), OrePrefix.dust.get(Materials.AnyCopper)});
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.BlackBronze, 5L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Gold), OrePrefix.dust.get(Materials.Silver), OrePrefix.dust.get(Materials.AnyCopper), OrePrefix.dust.get(Materials.AnyCopper), OrePrefix.dust.get(Materials.AnyCopper)});
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.BismuthBronze, 5L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Bismuth), OrePrefix.dust.get(Materials.Zinc), OrePrefix.dust.get(Materials.AnyCopper), OrePrefix.dust.get(Materials.AnyCopper), OrePrefix.dust.get(Materials.AnyCopper)});
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.BlackSteel, 5L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Nickel), OrePrefix.dust.get(Materials.BlackBronze), OrePrefix.dust.get(Materials.Steel), OrePrefix.dust.get(Materials.Steel), OrePrefix.dust.get(Materials.Steel)});
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.RedSteel, 8L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.SterlingSilver), OrePrefix.dust.get(Materials.BismuthBronze), OrePrefix.dust.get(Materials.Steel), OrePrefix.dust.get(Materials.Steel), OrePrefix.dust.get(Materials.BlackSteel), OrePrefix.dust.get(Materials.BlackSteel), OrePrefix.dust.get(Materials.BlackSteel), OrePrefix.dust.get(Materials.BlackSteel)});
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.BlueSteel, 8L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.RoseGold), OrePrefix.dust.get(Materials.Brass), OrePrefix.dust.get(Materials.Steel), OrePrefix.dust.get(Materials.Steel), OrePrefix.dust.get(Materials.BlackSteel), OrePrefix.dust.get(Materials.BlackSteel), OrePrefix.dust.get(Materials.BlackSteel), OrePrefix.dust.get(Materials.BlackSteel)});
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.Osmiridium, 4L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Iridium), OrePrefix.dust.get(Materials.Iridium), OrePrefix.dust.get(Materials.Iridium), OrePrefix.dust.get(Materials.Osmium)});

                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.Ultimet, 9L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Cobalt), OrePrefix.dust.get(Materials.Cobalt), OrePrefix.dust.get(Materials.Cobalt), OrePrefix.dust.get(Materials.Cobalt), OrePrefix.dust.get(Materials.Cobalt), OrePrefix.dust.get(Materials.Chrome), OrePrefix.dust.get(Materials.Chrome), OrePrefix.dust.get(Materials.Nickel), OrePrefix.dust.get(Materials.Molybdenum)});
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.CobaltBrass, 9L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Brass), OrePrefix.dust.get(Materials.Brass), OrePrefix.dust.get(Materials.Brass), OrePrefix.dust.get(Materials.Brass), OrePrefix.dust.get(Materials.Brass), OrePrefix.dust.get(Materials.Brass), OrePrefix.dust.get(Materials.Brass), OrePrefix.dust.get(Materials.Aluminium), OrePrefix.dust.get(Materials.Cobalt)});
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.StainlessSteel, 9L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Iron), OrePrefix.dust.get(Materials.Iron), OrePrefix.dust.get(Materials.Iron), OrePrefix.dust.get(Materials.Iron), OrePrefix.dust.get(Materials.Iron), OrePrefix.dust.get(Materials.Iron), OrePrefix.dust.get(Materials.Nickel), OrePrefix.dust.get(Materials.Manganese), OrePrefix.dust.get(Materials.Chrome)});
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.YttriumBariumCuprate, 6L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Yttrium), OrePrefix.dust.get(Materials.Barium), OrePrefix.dust.get(Materials.Barium), OrePrefix.dust.get(Materials.AnyCopper), OrePrefix.dust.get(Materials.AnyCopper), OrePrefix.dust.get(Materials.AnyCopper)});
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.Kanthal, 3L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Iron), OrePrefix.dust.get(Materials.Aluminium), OrePrefix.dust.get(Materials.Chrome)});

                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.Ultimet, 1), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dustTiny.get(Materials.Cobalt), OrePrefix.dustTiny.get(Materials.Cobalt), OrePrefix.dustTiny.get(Materials.Cobalt), OrePrefix.dustTiny.get(Materials.Cobalt), OrePrefix.dustTiny.get(Materials.Cobalt), OrePrefix.dustTiny.get(Materials.Chrome), OrePrefix.dustTiny.get(Materials.Chrome), OrePrefix.dustTiny.get(Materials.Nickel), OrePrefix.dustTiny.get(Materials.Molybdenum)});
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.CobaltBrass, 1), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dustTiny.get(Materials.Brass), OrePrefix.dustTiny.get(Materials.Brass), OrePrefix.dustTiny.get(Materials.Brass), OrePrefix.dustTiny.get(Materials.Brass), OrePrefix.dustTiny.get(Materials.Brass), OrePrefix.dustTiny.get(Materials.Brass), OrePrefix.dustTiny.get(Materials.Brass), OrePrefix.dustTiny.get(Materials.Aluminium), OrePrefix.dustTiny.get(Materials.Cobalt)});
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.StainlessSteel, 1), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dustTiny.get(Materials.Iron), OrePrefix.dustTiny.get(Materials.Iron), OrePrefix.dustTiny.get(Materials.Iron), OrePrefix.dustTiny.get(Materials.Iron), OrePrefix.dustTiny.get(Materials.Iron), OrePrefix.dustTiny.get(Materials.Iron), OrePrefix.dustTiny.get(Materials.Nickel), OrePrefix.dustTiny.get(Materials.Manganese), OrePrefix.dustTiny.get(Materials.Chrome)});
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dustTiny, Materials.YttriumBariumCuprate, 6L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dustTiny.get(Materials.Yttrium), OrePrefix.dustTiny.get(Materials.Barium), OrePrefix.dustTiny.get(Materials.Barium), OrePrefix.dustTiny.get(Materials.AnyCopper), OrePrefix.dustTiny.get(Materials.AnyCopper), OrePrefix.dustTiny.get(Materials.AnyCopper)});
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dustTiny, Materials.Kanthal, 3L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dustTiny.get(Materials.Iron), OrePrefix.dustTiny.get(Materials.Aluminium), OrePrefix.dustTiny.get(Materials.Chrome)});

                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.VanadiumSteel, 9L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Steel), OrePrefix.dust.get(Materials.Steel), OrePrefix.dust.get(Materials.Steel), OrePrefix.dust.get(Materials.Steel), OrePrefix.dust.get(Materials.Steel), OrePrefix.dust.get(Materials.Steel), OrePrefix.dust.get(Materials.Steel), OrePrefix.dust.get(Materials.Vanadium), OrePrefix.dust.get(Materials.Chrome)});
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.HSSG, 9L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.TungstenSteel), OrePrefix.dust.get(Materials.TungstenSteel), OrePrefix.dust.get(Materials.TungstenSteel), OrePrefix.dust.get(Materials.TungstenSteel), OrePrefix.dust.get(Materials.TungstenSteel), OrePrefix.dust.get(Materials.Chrome), OrePrefix.dust.get(Materials.Molybdenum), OrePrefix.dust.get(Materials.Molybdenum), OrePrefix.dust.get(Materials.Vanadium)});
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.HSSE, 9L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.HSSG), OrePrefix.dust.get(Materials.HSSG), OrePrefix.dust.get(Materials.HSSG), OrePrefix.dust.get(Materials.HSSG), OrePrefix.dust.get(Materials.HSSG), OrePrefix.dust.get(Materials.HSSG), OrePrefix.dust.get(Materials.Cobalt), OrePrefix.dust.get(Materials.Manganese), OrePrefix.dust.get(Materials.Silicon)});
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.HSSS, 9L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.HSSG), OrePrefix.dust.get(Materials.HSSG), OrePrefix.dust.get(Materials.HSSG), OrePrefix.dust.get(Materials.HSSG), OrePrefix.dust.get(Materials.HSSG), OrePrefix.dust.get(Materials.HSSG), OrePrefix.dust.get(Materials.Iridium), OrePrefix.dust.get(Materials.Iridium), OrePrefix.dust.get(Materials.Osmium)});


                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.IronWood, 2L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Iron), OrePrefix.dust.get(Materials.LiveRoot), OrePrefix.dustTiny.get(Materials.Gold)});
                ...
                GT_ModHandler.addShapelessCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.Saltpeter, 5L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{OrePrefix.dust.get(Materials.Potassium), OrePrefix.cell.get(Materials.Nitrogen), OrePrefix.cell.get(Materials.Oxygen), OrePrefix.cell.get(Materials.Oxygen), OrePrefix.cell.get(Materials.Oxygen)});
                ...
                if(Loader.isModLoaded("ImmersiveEngineering")){
                        GT_ModHandler.removeRecipeByOutput(OreDictUnifier.get(OrePrefix.stick, Materials.Iron, 4));
                        GT_ModHandler.removeRecipeByOutput(OreDictUnifier.get(OrePrefix.stick, Materials.Steel, 4));
                        GT_ModHandler.removeRecipeByOutput(OreDictUnifier.get(OrePrefix.stick, Materials.Aluminium, 4));
                }
                ...
                GTValues.RA.addWiremillRecipe(OreDictUnifier.get(OrePrefix.pipeTiny, Materials.Steel, 1), GT_ModHandler.getIC2Item(BlockName.mining_pipe, BlockMiningPipe.MiningPipeType.pipe, 1), 200, 16);
                ...
                GT_ModHandler.removeRecipe(new ItemStack[]{tStack = OreDictUnifier.get(OrePrefix.dust, Materials.Sulfur, 1), tStack, tStack, tStack, new ItemStack(Items.COAL, 1, 0), tStack, tStack, tStack, tStack});
                GT_ModHandler.removeRecipe(new ItemStack[]{tStack = OreDictUnifier.get(OrePrefix.dust, Materials.Sulfur, 1), tStack, tStack, tStack, new ItemStack(Items.COAL, 1, 1), tStack, tStack, tStack, tStack});
                GT_ModHandler.removeRecipe(new ItemStack[]{null, tStack = new ItemStack(Items.COAL, 1), null, tStack, OreDictUnifier.get(OrePrefix.ingot, Materials.Iron, 1), tStack, null, tStack, null});
                ...
                if ((GregTechAPI.sRecipeFile.get(ConfigCategories.Recipes.harderrecipes, "nuclearReactor", true)) &&
                        ...
                        GTValues.RA.addAssemblerRecipe(ItemList.Hull_EV.get(1, new Object[0]), OreDictUnifier.get(OrePrefix.plate, Materials.Lead, 4), GT_ModHandler.getIC2TEItem(TeBlock.reactor_chamber, 1), 200, 256);

                        GT_ModHandler.removeRecipeByOutput(GT_ModHandler.getIC2Item(BlockName.resource, ResourceBlock.reactor_vessel, 1));
                        GTValues.RA.addChemicalBathRecipe(OreDictUnifier.get(OrePrefix.frameGt, Materials.Lead, 1), Materials.Concrete.getMolten(144), GT_ModHandler.getIC2Item(BlockName.resource, ResourceBlock.reactor_vessel, 1), GTValues.NI, GTValues.NI, null, 400, 80);

                        GT_ModHandler.removeRecipeByOutput(GT_ModHandler.getIC2TEItem(TeBlock.reactor_access_hatch, 1));
                        GTValues.RA.addAssemblerRecipe(GT_ModHandler.getIC2Item(BlockName.resource, ResourceBlock.reactor_vessel, 1), ItemList.Conveyor_Module_EV.get(1, new Object[0]), GT_ModHandler.getIC2TEItem(TeBlock.reactor_access_hatch, 1), 200, 80);

                        GT_ModHandler.removeRecipeByOutput(GT_ModHandler.getIC2TEItem(TeBlock.reactor_fluid_port, 1));
                        GTValues.RA.addAssemblerRecipe(GT_ModHandler.getIC2Item(BlockName.resource, ResourceBlock.reactor_vessel, 1), ItemList.Electric_Pump_EV.get(1, new Object[0]), GT_ModHandler.getIC2TEItem(TeBlock.reactor_fluid_port, 1), 200, 80);

                        GT_ModHandler.removeRecipeByOutput(GT_ModHandler.getIC2TEItem(TeBlock.reactor_redstone_port, 1));
                        GTValues.RA.addAssemblerRecipe(GT_ModHandler.getIC2Item(BlockName.resource, ResourceBlock.reactor_vessel, 1), OreDictUnifier.get(OrePrefix.circuit, Materials.Master, 1), GT_ModHandler.getIC2TEItem(TeBlock.reactor_redstone_port, 1), 200, 80);
                }
                ...
                if ((GregTechAPI.sRecipeFile.get(ConfigCategories.Recipes.harderrecipes, "sugarpaper", true))) {
                        ...
                        GT_ModHandler.addCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.Paper, 2), new Object[]{"SSS", " m ", 'S', new ItemStack(Items.REEDS)});
                        GT_ModHandler.addCraftingRecipe(OreDictUnifier.get(OrePrefix.dust, Materials.Sugar, 1), new Object[]{"Sm ", 'S', new ItemStack(Items.REEDS)});
                        ...
                        //GT_ModHandler.addCraftingRecipe(OreDictUnifier.get(OrePrefix.paper, Materials.Empty, 2), new Object[]{" C ", "SSS", " C ", 'S', OreDictUnifier.get(OrePrefix.dust, Materials.Paper, 1), 'C', brick});
                        GT_ModHandler.addCraftingRecipe(OreDictUnifier.get(OrePrefix.paper, Materials.Empty, 2), new Object[]{" C ", "SSS", " C ", 'S', OreDictUnifier.get(OrePrefix.dust, Materials.Paper, 1), 'C', new ItemStack(Blocks.STONE_SLAB)});
                ...
                if(Loader.isModLoaded("GraviSuite")){
                        GT_ModHandler.removeRecipeByOutput(GT_ModHandler.getModItem("GraviSuite", "advNanoChestPlate", 1, GTValues.W));
                        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem("GraviSuite", "advNanoChestPlate", 1, GTValues.W), new Object[]{"CJC","CNC","WPW",'C', OrePrefix.plateAlloy.get(Materials.Carbon),'J',GT_ModHandler.getModItem("GraviSuite", "advJetpack", 1, GTValues.W),'N',GT_ModHandler.getIC2Item(ItemName.nano_chestplate, 1),'W', OrePrefix.wireGt04.get(Materials.Platinum),'P', OrePrefix.circuit.get(Materials.Elite)});
                }
