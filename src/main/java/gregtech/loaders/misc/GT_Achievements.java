...
public class GT_Achievements {
    ...
    public GT_Achievements() {
        ...
        registerAchievement("crushed", 0, 6, OreDictionaryUnifier.get(OrePrefix.crushed, Materials.Tin, 1L), "tools", false);
        registerAchievement("cleandust", 0, 10, OreDictionaryUnifier.get(OrePrefix.dust, Materials.Redstone, 1L), "crushed", false);
        registerAchievement("washing", -2, 6, OreDictionaryUnifier.get(OrePrefix.crushedPurified, Materials.Iron, 1L), "crushed", false);
        registerAchievement("spinit", -4, 6, OreDictionaryUnifier.get(OrePrefix.crushedCentrifuged, Materials.Redstone, 1L), "crushed", false);

        if (!GregTech_API.mIC2Classic) {
            registerAchievement("newfuel", -4, 8, ItemList.ThoriumCell_4.get(1), "spinit", false);
            registerAchievement("newmetal", -4, 10, OreDictionaryUnifier.get(OrePrefix.dust, Materials.Lutetium, 1L), "newfuel", false);
            registerAchievement("reflect", -2, 9, ItemList.Neutron_Reflector.get(1), "newfuel", false);
        }

        registerAchievement("bronze", 2, 0, OreDictionaryUnifier.get(OrePrefix.dust, Materials.Bronze, 1L), "flintpick", false);
        ...
        registerAchievement("steel", 4, 0, OreDictionaryUnifier.get(OrePrefix.ingot, Materials.Steel, 1L), "bronze", false);
        ...
        registerAchievement("complexalloys", 6, 3, OreDictionaryUnifier.get(OrePrefix.ingot, Materials.BlueSteel, 1L), "cheapermac", false);

        registerAchievement("magneticiron", 4, -2, OreDictionaryUnifier.get(OrePrefix.stick, Materials.IronMagnetic, 1L), "steel", false);
        ...
        registerAchievement("gtaluminium", 8, 0, OreDictionaryUnifier.get(OrePrefix.ingot, Materials.Aluminium, 1L), "steel", false);
        ...
        registerAchievement("titan", 14, 0, OreDictionaryUnifier.get(OrePrefix.ingot, Materials.Titanium, 1L), "upgrade", false);
        ...
        registerAchievement("tungsten", 16, 2, OreDictionaryUnifier.get(OrePrefix.ingot, Materials.Tungsten, 1L), "upgrade2", false);
        registerAchievement("osmium", 16, -2, OreDictionaryUnifier.get(OrePrefix.ingot, Materials.Osmium, 1L), "upgrade2", false);
        ...
        registerAchievement("tungstensteel", 16, 4, OreDictionaryUnifier.get(OrePrefix.ingot, Materials.TungstenSteel, 1L), "tungsten", false);
        registerAchievement("upgrade3", 15, 5, ItemList.Casing_Coil_TungstenSteel.get(1), "tungstensteel", false);
        registerAchievement("hssg", 13, 5, OreDictionaryUnifier.get(OrePrefix.ingot, Materials.HSSG, 1L), "upgrade3", false);
        registerAchievement("upgrade4", 11, 5, ItemList.Casing_Coil_HSSG.get(1), "hssg", false);
        registerAchievement("stargatematerial", 11, 7, OreDictionaryUnifier.get(OrePrefix.ingot, Materials.Naquadah, 1L), "upgrade4", false);
        ...
        registerAchievement("alienmetallurgy", 9, 7, OreDictionaryUnifier.get(OrePrefix.ingot, Materials.NaquadahAlloy, 1L), "upgrade5", false);
        registerAchievement("over9000", 7, 7, ItemList.Casing_Coil_NaquadahAlloy.get(1), "alienmetallurgy", false);
        registerAchievement("finalpreparations", 7, 9, OreDictionaryUnifier.get(OrePrefix.ingot, Materials.Naquadria, 1L), "over9000", false);
        ...
        if(Loader.isModLoaded("JustEnoughItems") && GT_Mod.gregtechproxy.mHideUnusedOres){
            for (int i = 1; i < GregTech_API.sGeneratedMaterials.length; i++) {
                if(GregTech_API.sGeneratedMaterials[i] != null && !oreList.contains(GregTech_API.sGeneratedMaterials[i])){
                    Internal.getHelpers().getItemBlacklist().addItemToBlacklist(OreDictionaryUnifier.get(OrePrefix.ore, GregTech_API.sGeneratedMaterials[i], 1));
                }
            }
        }
    ...
    public void issueAchivementHatch(EntityPlayer player, ItemStack stack) {
        ...
        if (data != null && data.mPrefix == OrePrefix.ingot) {
    ...
    public void onCrafting(ItemCraftedEvent event) {
        ...
        ItemMaterialInfo data = OreDictionaryUnifier.getItemData(stack);
        if (data != null) {
            if (data.mPrefix == OrePrefix.dust && data.mMaterial.mMaterial == Materials.Bronze) {
                issueAchievement(player, "bronze");
            } else if (data.mPrefix == OrePrefix.circuit && data.mMaterial.mMaterial == Materials.Advanced) {
    ...
    public void onItemPickup(EntityItemPickupEvent event) {
        ...
        if (data != null && data.mPrefix != null) {
            if (data.mPrefix == OrePrefix.dust) {
            ...
            } else if (data.mPrefix == OrePrefix.crushed) {
                issueAchievement(player, "crushed");
            } else if (data.mPrefix == OrePrefix.crushedPurified) {
                issueAchievement(player, "washing");
            } else if (data.mPrefix == OrePrefix.crushedCentrifuged) {
                issueAchievement(player, "spinit");
            } else if (data.mMaterial.mMaterial == Materials.Steel) {
                if (data.mPrefix == OrePrefix.ingot && stack.stackSize == stack.getMaxStackSize()) {
                    issueAchievement(player, "steel");
                } /* TODO THAUMCRAFT 1.10 else if (data.mPrefix == OrePrefix.nugget && Loader.isModLoaded("Thaumcraft") && ThaumcraftApiHelper.isResearchComplete(player.getDisplayName(), "GT_IRON_TO_STEEL")) {
                    issueAchievement(player, "steel");
                }*/
            } else if (data.mPrefix == OrePrefix.circuit && data.mMaterial.mMaterial == Materials.Advanced) {
                issueAchievement(player, "stepforward");
