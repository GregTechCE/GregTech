...
public class GT_CoverLoader
    ...
    public void run() {
        for (byte i = 0; i < 16; i = (byte) (i + 1)) {
            GregTech_API.registerCover(new ItemStack(Blocks.CARPET, 1, i), new GT_RenderedTexture(new RegIconContainer("blocks/wool_colored_" + EnumDyeColor.byMetadata(i).name().toLowerCase())), null);
        }
