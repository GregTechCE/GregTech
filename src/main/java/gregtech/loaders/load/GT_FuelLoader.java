...
public class GT_FuelLoader
    ...
    public void run() {
        ...
        new GT_Recipe(new ItemStack(Items.LAVA_BUCKET), new ItemStack(Blocks.OBSIDIAN), OreDictionaryUnifier.get(OrePrefixes.ingot, Materials.Copper, 1L), OreDictionaryUnifier.get(OrePrefixes.ingot, Materials.Tin, 1L), OreDictionaryUnifier.get(OrePrefixes.ingot, Materials.Electrum, 1L), 30, 2);

        GT_Recipe.GT_Recipe_Map.sSmallNaquadahReactorFuels.addRecipe(true, new ItemStack[]{OreDictionaryUnifier.get(OrePrefixes.bolt, Materials.NaquadahEnriched, 1L)}, new ItemStack[]{OreDictionaryUnifier.get(OrePrefixes.bolt, Materials.Naquadah, 1L)}, null, null, null, 0, 0, 25000);
        GT_Recipe.GT_Recipe_Map.sLargeNaquadahReactorFuels.addRecipe(true, new ItemStack[]{OreDictionaryUnifier.get(OrePrefixes.ingot, Materials.NaquadahEnriched, 1L)}, new ItemStack[]{OreDictionaryUnifier.get(OrePrefixes.ingot, Materials.Naquadah, 1L)}, null, null, null, 0, 0, 200000);
        GT_Recipe.GT_Recipe_Map.sFluidNaquadahReactorFuels.addRecipe(true, new ItemStack[]{OreDictionaryUnifier.get(OrePrefixes.cell, Materials.NaquadahEnriched, 1L)}, new ItemStack[]{OreDictionaryUnifier.get(OrePrefixes.cell,  Materials.Naquadah, 1L)}, null, null, null, 0, 0, 1400000);
