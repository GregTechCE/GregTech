    ...
    public void registerOre(UnificationEntry uEntry, String modName, SimpleItemStack simpleStack) {
        ...
        if (uEntry.orePrefix == OrePrefix.stick) {
            if (!uEntry.material.hasFlag(DustMaterial.MatFlags.NO_WORKING)) {
                ...
                GTValues.RA.addCutterRecipe(GT_Utility.copyAmount(1L, new Object[]{stack}), OreDictionaryUnifier.get(OrePrefix.bolt, uEntry.material, 4L), null, (int) Math.max(uEntry.material.getMass() * 2L, 1L), 4);
            ...
            if (!uEntry.material.hasFlag(DustMaterial.MatFlags.NO_SMASHING)) {
                GTValues.RA.addForgeHammerRecipe(GT_Utility.copyAmount(2L, new Object[]{stack}), OreDictionaryUnifier.get(OrePrefix.stickLong, uEntry.material, 1L), (int) Math.max(uEntry.material.getMass(), 1L), 16);
            }
        } else if (uEntry.orePrefix == OrePrefix.stickLong) {
            if (!uEntry.material.hasFlag(DustMaterial.MatFlags.NO_WORKING)) {
                GTValues.RA.addCutterRecipe(GT_Utility.copyAmount(1L, new Object[]{stack}), OreDictionaryUnifier.get(OrePrefix.stick, uEntry.material, 2), null, (int) Math.max(uEntry.material.getMass(), 1L), 4);
                if (uEntry.material.mUnificatable && (uEntry.material.mMaterialInto == uEntry.material)) {
            ...
            if (!uEntry.material.hasFlag(DustMaterial.MatFlags.NO_SMASHING)) {
                GTValues.RA.addBenderRecipe(GT_Utility.copyAmount(1L, new Object[]{stack}), OreDictionaryUnifier.get(OrePrefix.spring, uEntry.material, 1), 200, 16);
                if (uEntry.material.mUnificatable && (uEntry.material.mMaterialInto == uEntry.material)) {
