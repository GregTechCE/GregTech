    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName, ItemStack aStack) {
        ...
        switch (aMaterial) {
            case _NULL:
                ...
                break;
            case Sand:
                GT_ModHandler.addPulverisationRecipe(GT_Utility.copyAmount(1, aStack), new ItemStack(Blocks.SAND, 1, 0), null, 10, false);
                break;
            case Endstone:
                GT_ModHandler.addPulverisationRecipe(GT_Utility.copyAmount(1, aStack), GT_OreDictUnificator.get(OrePrefixes.dustImpure, Materials.Endstone, 1), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Tungsten, 1), 5, false);
                break;
            case Netherrack:
                GT_ModHandler.addPulverisationRecipe(GT_Utility.copyAmount(1, aStack), GT_OreDictUnificator.get(OrePrefixes.dustImpure, Materials.Netherrack, 1), GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Gold, 1), 5, false);
                break;
            case NetherBrick:
                GT_Values.RA.addAssemblerRecipe(GT_Utility.copyAmount(1, aStack), ItemList.Circuit_Integrated.getWithDamage(0L, 1), new ItemStack(Blocks.NETHER_BRICK_FENCE, 1), 100, 4);
                break;
            case Obsidian:
                if (aBlock != Blocks.AIR) aBlock.setResistance(20.0F);
                GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone, 2L), GT_Utility.copyAmount(5L, aStack), Materials.Glass.getMolten(72L), GT_ModHandler.getModItem("Forestry", "thermionicTubes", 4, 6), 64, 32);
                GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.NetherStar, 1), GT_Utility.copyAmount(3L, aStack), Materials.Glass.getMolten(720L), new ItemStack(Blocks.BEACON, 1, 0), 32, 16);
                GT_Values.RA.addAssemblerRecipe(GT_Utility.copyAmount(1, aStack), ItemList.IC2_Compressed_Coal_Ball.get(8L), ItemList.IC2_Compressed_Coal_Chunk.get(1), 400, 4);
                GT_Values.RA.addAssemblerRecipe(GT_Utility.copyAmount(8L, aStack), GT_OreDictUnificator.get(OrePrefixes.gem, Materials.EnderEye, 1), new ItemStack(Blocks.ENDER_CHEST, 1), 400, 4);
                GT_ModHandler.addPulverisationRecipe(GT_Utility.copyAmount(1, aStack), GT_ModHandler.getModItem("Railcraft", "cube.crushed.obsidian", 1, GT_OreDictUnificator.get(OrePrefixes.dust, aMaterial, 1)), GT_OreDictUnificator.get(OrePrefixes.dust, aMaterial, 1), 10, true);
            ...
            case Quartzite:
                ...
                break;
            case Flint:
                GT_ModHandler.addPulverisationRecipe(GT_Utility.copyAmount(1, aStack), GT_OreDictUnificator.get(OrePrefixes.dustImpure, aMaterial, 2L), new ItemStack(Items.FLINT, 1), 50, false);
                break;
            case GraniteBlack:
                GT_Values.RA.addCutterRecipe(GT_Utility.copyAmount(1, aStack), GT_OreDictUnificator.get(OrePrefixes.plate, aMaterial, 1), null, 200, 32);
