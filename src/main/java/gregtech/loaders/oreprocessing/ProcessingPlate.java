        ...
        switch (aPrefix) {
            case plate:
                ...
                if (aMaterial.mStandardMoltenFluid != null) {
                    GT_Values.RA.addFluidSolidifierRecipe(ItemList.Shape_Mold_Plate.get(0L), aMaterial.getMolten(144L), OreDictionaryUnifier.get(OrePrefixes.plate, aMaterial, 1L), 32, 8);
                }
                ...
                GT_Utility.removeSimpleIC2MachineRecipe(GT_Utility.copyAmount(9L, aStack), Recipes.compressor.getRecipes(), OreDictionaryUnifier.get(OrePrefixes.plateDense, aMaterial, 1L));
                GT_Values.RA.addImplosionRecipe(GT_Utility.copyAmount(2L, aStack), 2, OreDictionaryUnifier.get(OrePrefixes.compressed, aMaterial, 1L), OreDictionaryUnifier.get(OrePrefixes.dustTiny, Materials.DarkAsh, 1L));
                ...
                if ((aMaterial.mUnificatable) && (aMaterial.mMaterialInto == aMaterial)) {
                    if (!aNoSmashing && GregTech_API.sRecipeFile.get(ConfigCategories.Tools.hammerplating, aMaterial.toString(), true)) {
                        GT_ModHandler.addCraftingRecipe(OreDictionaryUnifier.get(OrePrefixes.plate, aMaterial, 1L), GT_Proxy.tBits, new Object[]{"h", "X", "X", 'X', OrePrefixes.ingot.get(aMaterial)});
                        GT_ModHandler.addCraftingRecipe(OreDictionaryUnifier.get(OrePrefixes.plate, aMaterial, 1L), GT_Proxy.tBits, new Object[]{"H", "X", 'H', ToolDictNames.craftingToolForgeHammer, 'X', OrePrefixes.ingot.get(aMaterial)});
                        GT_ModHandler.addCraftingRecipe(OreDictionaryUnifier.get(OrePrefixes.plate, aMaterial, 1L), GT_Proxy.tBits, new Object[]{"h", "X", 'X', OrePrefixes.gem.get(aMaterial)});
                        GT_ModHandler.addCraftingRecipe(OreDictionaryUnifier.get(OrePrefixes.plate, aMaterial, 1L), GT_Proxy.tBits, new Object[]{"H", "X", 'H', ToolDictNames.craftingToolForgeHammer, 'X', OrePrefixes.gem.get(aMaterial)});
                        GT_ModHandler.addCraftingRecipe(OreDictionaryUnifier.get(OrePrefixes.plate, aMaterial, 1L), GT_Proxy.tBits, new Object[]{"h", "X", 'X', OrePrefixes.ingotDouble.get(aMaterial)});
                        GT_ModHandler.addCraftingRecipe(OreDictionaryUnifier.get(OrePrefixes.plate, aMaterial, 2L), GT_Proxy.tBits, new Object[]{"H", "X", 'H', ToolDictNames.craftingToolForgeHammer, 'X', OrePrefixes.ingotDouble.get(aMaterial)});
                    }
                    if ((aMaterial.contains(SubTag.MORTAR_GRINDABLE)) && (GregTech_API.sRecipeFile.get(ConfigCategories.Tools.mortar, aMaterial.mName, true)))
                        GT_ModHandler.addCraftingRecipe(OreDictionaryUnifier.get(OrePrefixes.dust, aMaterial, 1L), GT_Proxy.tBits, new Object[]{"X", "m", 'X', OrePrefixes.plate.get(aMaterial)});
                }
                break;
            case plateDouble:
                GT_ModHandler.removeRecipeByOutput(aStack);
                ...
                if (!aNoSmashing) {
                    GT_Values.RA.addBenderRecipe(GT_Utility.copyAmount(2L, aStack), OreDictionaryUnifier.get(OrePrefixes.plateQuadruple, aMaterial, 1L), (int) Math.max(aMaterialMass * 2L, 1L), 96);
                    ...
                    GT_Values.RA.addBenderRecipe(OreDictionaryUnifier.get(OrePrefixes.plate, aMaterial, 2L), GT_Utility.copyAmount(1L, aStack), (int) Math.max(aMaterialMass * 2L, 1L), 96);
                } else {
                        GT_Values.RA.addAssemblerRecipe(OreDictionaryUnifier.get(OrePrefixes.plate, aMaterial, 2L), ItemList.Circuit_Integrated.getWithDamage(0L, 2L), Materials.Glue.getFluid(10L), GT_Utility.copyAmount(1L, aStack), 64, 8);
                    }
                break;
            case plateTriple:
                GT_ModHandler.removeRecipeByOutput(aStack);
                ...
                if (!aNoSmashing) {
                    GT_Values.RA.addBenderRecipe(GT_Utility.copyAmount(3L, aStack), OreDictionaryUnifier.get(OrePrefixes.plateDense, aMaterial, 1L), (int) Math.max(aMaterialMass * 3L, 1L), 96);
                    ...
                    GT_Values.RA.addBenderRecipe(OreDictionaryUnifier.get(OrePrefixes.plate, aMaterial, 3L), GT_Utility.copyAmount(1L, aStack), (int) Math.max(aMaterialMass * 3L, 1L), 96);
                }else {
                        GT_Values.RA.addAssemblerRecipe(OreDictionaryUnifier.get(OrePrefixes.plate, aMaterial, 3L), ItemList.Circuit_Integrated.getWithDamage(0L, 3L), Materials.Glue.getFluid(20L), GT_Utility.copyAmount(1L, aStack), 96, 8);
                    }
                break;
            case plateQuadruple:
                GT_ModHandler.removeRecipeByOutput(aStack);
                ...
                if (!aNoWorking)
                    GT_Values.RA.addCNCRecipe(GT_Utility.copyAmount(1L, aStack), OreDictionaryUnifier.get(OrePrefixes.gearGt, aMaterial, 1L), (int) Math.max(aMaterialMass * 2L, 1L), 32);
                if (!aNoSmashing) {
                    ...
                    GT_Values.RA.addBenderRecipe(OreDictionaryUnifier.get(OrePrefixes.plate, aMaterial, 4L), GT_Utility.copyAmount(1L, aStack), (int) Math.max(aMaterialMass * 4L, 1L), 96);
                } else {
                        GT_Values.RA.addAssemblerRecipe(OreDictionaryUnifier.get(OrePrefixes.plate, aMaterial, 4L), ItemList.Circuit_Integrated.getWithDamage(0L, 4L), Materials.Glue.getFluid(30L), GT_Utility.copyAmount(1L, aStack), 128, 8);
                    }
                break;
            case plateQuintuple:
                GT_ModHandler.removeRecipeByOutput(aStack);
                ...
                if (!aNoSmashing) {
                    ...
                    GT_Values.RA.addBenderRecipe(OreDictionaryUnifier.get(OrePrefixes.plate, aMaterial, 5L), GT_Utility.copyAmount(1L, aStack), (int) Math.max(aMaterialMass * 5L, 1L), 96);
                } else {
                        GT_Values.RA.addAssemblerRecipe(OreDictionaryUnifier.get(OrePrefixes.plate, aMaterial, 5L), ItemList.Circuit_Integrated.getWithDamage(0L, 5L), Materials.Glue.getFluid(40L), GT_Utility.copyAmount(1L, aStack), 160, 8);
                    }
                break;
            case plateDense:
                GT_ModHandler.removeRecipeByOutput(aStack);
                ...
                if (!aNoSmashing) {
                    GT_Values.RA.addBenderRecipe(OreDictionaryUnifier.get(OrePrefixes.plate, aMaterial, 9L), GT_Utility.copyAmount(1, aStack), (int) Math.max(aMaterialMass * 9L, 1L), 96);
                }
                break;
            case plateAlloy:
                switch (aOreDictName) {
                    ...
                    case "plateAlloyAdvanced":
                        ...
                        GT_ModHandler.addAlloySmelterRecipe(GT_Utility.copyAmount(1, aStack), OreDictionaryUnifier.get(OrePrefixes.dust, Materials.Glass, 3L), GT_ModHandler.getIC2Item(BlockName.glass, BlockTexGlass.GlassType.reinforced, 4), 400, 4, false);
