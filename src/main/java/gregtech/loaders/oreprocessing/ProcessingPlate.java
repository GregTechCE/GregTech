    ...
    public void registerOre(UnificationEntry uEntry, String modName, SimpleItemStack simpleStack) {
        ...
        switch (uEntry.orePrefix) {
            case plate:
                ...
                GTValues.RA.addImplosionRecipe(GT_Utility.copyAmount(2, stack), 2, OreDictionaryUnifier.get(OrePrefix.compressed, uEntry.material, 1L), OreDictionaryUnifier.get(OrePrefix.dustTiny, Materials.DarkAsh, 1L));
                if (uEntry.material == Materials.Paper)
                    ModHandler.addCraftingRecipe(GT_Utility.copyAmount(GregTechAPI.sRecipeFile.get(ConfigCategories.Recipes.harderrecipes, stack, true) ? 2 : 3, stack), "XXX", 'X', new ItemStack(net.minecraft.init.Items.REEDS, 1, 32767));
            ...
            case plateDouble:
                ...
                if (!aNoSmashing) {
                    GTValues.RA.addBenderRecipe(GT_Utility.copyAmount(2, stack), OreDictionaryUnifier.get(OrePrefix.plateQuadruple, uEntry.material, 1L), (int) Math.max(materialMass * 2L, 1L), 96);
                    ...
                    GTValues.RA.addBenderRecipe(OreDictionaryUnifier.get(OrePrefix.plate, uEntry.material, 2L), GT_Utility.copyAmount(1L, stack), (int) Math.max(materialMass * 2L, 1L), 96);
                } else {
                        GTValues.RA.addAssemblerRecipe(OreDictionaryUnifier.get(OrePrefix.plate, uEntry.material, 2L), ItemList.Circuit_Integrated.getWithDamage(0L, 2L), Materials.Glue.getFluid(10L), GT_Utility.copyAmount(1L, stack), 64, 8);
                    }
                break;
            case plateTriple:
                ModHandler.removeRecipeByOutput(stack);
                ...
                if (!aNoSmashing) {
                    GTValues.RA.addBenderRecipe(GT_Utility.copyAmount(3L, stack), OreDictionaryUnifier.get(OrePrefix.plateDense, uEntry.material, 1L), (int) Math.max(uEntry.materialMass * 3L, 1L), 96);
                    ...
                    GTValues.RA.addBenderRecipe(OreDictionaryUnifier.get(OrePrefix.plate, uEntry.material, 3L), GT_Utility.copyAmount(1L, stack), (int) Math.max(uEntry.materialMass * 3L, 1L), 96);
                }else {
                        GTValues.RA.addAssemblerRecipe(OreDictionaryUnifier.get(OrePrefix.plate, uEntry.material, 3L), ItemList.Circuit_Integrated.getWithDamage(0L, 3L), Materials.Glue.getFluid(20L), GT_Utility.copyAmount(1L, stack), 96, 8);
                    }
                break;
            case plateQuadruple:
                ModHandler.removeRecipeByOutput(stack);
                ...
                if (!aNoWorking)
                    GTValues.RA.addCNCRecipe(GT_Utility.copyAmount(1L, stack), OreDictionaryUnifier.get(OrePrefix.gearGt, uEntry.material, 1L), (int) Math.max(materialMass * 2L, 1L), 32);
                if (!aNoSmashing) {
                    ...
                    GTValues.RA.addBenderRecipe(OreDictionaryUnifier.get(OrePrefix.plate, uEntry.material, 4L), GT_Utility.copyAmount(1L, stack), (int) Math.max(materialMass * 4L, 1L), 96);
                } else {
                        GTValues.RA.addAssemblerRecipe(OreDictionaryUnifier.get(OrePrefix.plate, uEntry.material, 4L), ItemList.Circuit_Integrated.getWithDamage(0L, 4L), Materials.Glue.getFluid(30L), GT_Utility.copyAmount(1L, stack), 128, 8);
                    }
                break;
            case plateQuintuple:
                ModHandler.removeRecipeByOutput(stack);
                ...
                if (!aNoSmashing) {
                    ...
                    GTValues.RA.addBenderRecipe(OreDictionaryUnifier.get(OrePrefix.plate, uEntry.material, 5L), GT_Utility.copyAmount(1L, stack), (int) Math.max(materialMass * 5L, 1L), 96);
                } else {
                        GTValues.RA.addAssemblerRecipe(OreDictionaryUnifier.get(OrePrefix.plate, uEntry.material, 5L), ItemList.Circuit_Integrated.getWithDamage(0L, 5L), Materials.Glue.getFluid(40L), GT_Utility.copyAmount(1L, stack), 160, 8);
                    }
                break;
            case plateDense:
                ModHandler.removeRecipeByOutput(stack);
                ...
                if (!aNoSmashing) {
                    GTValues.RA.addBenderRecipe(OreDictionaryUnifier.get(OrePrefix.plate, uEntry.material, 9L), GT_Utility.copyAmount(1, stack), (int) Math.max(materialMass * 9L, 1L), 96);
                }
                break;
            case plateAlloy:
                switch (aOreDictName) {
                    case "plateAlloyCarbon":
                        GTValues.RA.addAssemblerRecipe(ModHandler.getIC2TEItem(TeBlock.generator, 1), GT_Utility.copyAmount(4, stack), ModHandler.getIC2TEItem(TeBlock.wind_generator, 1), 6400, 8);
