...
public class ProcessingDye implements IOreRegistrationHandler {
    ...
    public void registerOre(OrePrefix aPrefix, Materials aMaterial, String aOreDictName, String aModName, ItemStack aStack) {
        ...
        if ((aDye.mIndex >= 0) && (aDye.mIndex < 16) &&
            ...
            GT_ModHandler.addAlloySmelterRecipe(OreDictionaryUnifier.get(OrePrefix.dust, Materials.Glass, 8L), GT_Utility.copyAmount(1L, new Object[]{aStack}), new ItemStack(Blocks.STAINED_GLASS, 8, 15 - aDye.mIndex), 200, 8, false);
            ...
            GT_Values.RA.addChemicalRecipe(GT_Utility.copyAmount(1L, new Object[]{aStack}), OreDictionaryUnifier.get(OrePrefix.dust, Materials.Salt, 2), Materials.SulfuricAcid.getFluid(432), FluidRegistry.getFluidStack("dye.chemical." + aDye.name().toLowerCase(Locale.ENGLISH), 288), GT_Values.NI, 600, 48);
        }
    }
}
