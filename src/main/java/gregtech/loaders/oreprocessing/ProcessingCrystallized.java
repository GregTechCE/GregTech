...
public class ProcessingCrystallized implements IOreRegistrationHandler {
    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName, ItemStack aStack) {
        ...
        GT_ModHandler.addPulverisationRecipe(GT_Utility.copyAmount(1L, new Object[]{aStack}), OreDictionaryUnifier.get(OrePrefixes.dust, aMaterial.mMacerateInto, 1L), null, 10, false);
    }
}
