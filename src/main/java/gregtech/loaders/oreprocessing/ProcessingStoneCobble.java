...
public class ProcessingStoneCobble implements IOreRegistrationHandler {
    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName, ItemStack aStack) {
        GT_Values.RA.addAssemblerRecipe(GT_Utility.copyAmount(1L, aStack), OreDictionaryUnifier.get(OrePrefixes.stick, Materials.Wood, 1L), new ItemStack(Blocks.LEVER, 1), 400, 1);
        ...
        GT_Values.RA.addAssemblerRecipe(GT_Utility.copyAmount(7L, aStack), OreDictionaryUnifier.get(OrePrefixes.dust, Materials.Redstone, 1L), new ItemStack(Blocks.DROPPER, 1), 400, 4);
