            ...
            case wireGt01:
                switch (uEntry.material.toString()){
                    ...
                    default:
                        ...
                        GTValues.RA.addUnboxingRecipe(OreDictionaryUnifier.get(OrePrefix.cableGt01, uEntry.material, 1L), GTUtility.copyAmount(1L, new Object[]{stack}), OreDictionaryUnifier.get(OrePrefix.plate, Materials.Rubber, 1L), 100, 8);
                }
                if (!uEntry.material.hasFlag(DustMaterial.MatFlags.NO_SMASHING)) {
                    GTValues.RA.addBenderRecipe(GTUtility.copyAmount(1L, new Object[]{stack}), OreDictionaryUnifier.get(OrePrefix.springSmall, uEntry.material, 2L), 100, 8);
                    GTValues.RA.addWiremillRecipe(GTUtility.copyAmount(1L, new Object[]{stack}), OreDictionaryUnifier.get(OrePrefix.wireFine, uEntry.material, 4L), 200, 8);
                    GTValues.RA.addWiremillRecipe(OreDictionaryUnifier.get(OrePrefix.ingot, uEntry.material, 1L), GTUtility.copy(new Object[]{GTUtility.copyAmount(2L, stack), OreDictionaryUnifier.get(OrePrefix.wireFine, uEntry.material, 8L)}), 100, 4);
            ...
            case wireGt02:
                switch (uEntry.material.toString()){
                    case "Cobalt": case "Lead": case "Tin": case "Zinc":case "SolderingAlloy":
                        ...
                        GTValues.RA.addBoxingRecipe(GTUtility.copyAmount(1L, new Object[]{stack}), new ItemStack(Blocks.CARPET, 1, 15), OreDictionaryUnifier.get(OrePrefix.cableGt02, uEntry.material, 1L), 100, 8);
                        GTValues.RA.addUnboxingRecipe(OreDictionaryUnifier.get(OrePrefix.cableGt02, uEntry.material, 1L), GTUtility.copyAmount(1L, new Object[]{stack}), new ItemStack(Blocks.CARPET, 1, 15), 100, 8);
                        break;
                    case "RedAlloy":
                        ...
                        GTValues.RA.addBoxingRecipe(GTUtility.copyAmount(1L, new Object[]{stack}), OreDictionaryUnifier.get(OrePrefix.plate, Materials.Paper, 1L), OreDictionaryUnifier.get(OrePrefix.cableGt02, uEntry.material, 1L), 100, 8);
                        GTValues.RA.addUnboxingRecipe(OreDictionaryUnifier.get(OrePrefix.cableGt02, uEntry.material, 1L), GTUtility.copyAmount(1L, new Object[]{stack}), OreDictionaryUnifier.get(OrePrefix.plate, Materials.Paper, 1L), 100, 8);
                        break;
                    default:
                        ...
                        GTValues.RA.addUnboxingRecipe(OreDictionaryUnifier.get(OrePrefix.cableGt02, uEntry.material, 1L), GTUtility.copyAmount(1L, new Object[]{stack}), OreDictionaryUnifier.get(OrePrefix.plate, Materials.Rubber, 1L), 100, 8);
                }
            ...
            case wireGt04:
                switch (uEntry.material.toString()){
                    case "Cobalt": case "Lead": case "Tin": case "Zinc":case "SolderingAlloy":
                        ...
                        GTValues.RA.addBoxingRecipe(GTUtility.copyAmount(1L, new Object[]{stack}), new ItemStack(Blocks.CARPET, 2, 15), OreDictionaryUnifier.get(OrePrefix.cableGt04, uEntry.material, 1L), 100, 8);
                        GTValues.RA.addUnboxingRecipe(OreDictionaryUnifier.get(OrePrefix.cableGt04, uEntry.material, 1L), GTUtility.copyAmount(1L, new Object[]{stack}), new ItemStack(Blocks.CARPET, 2, 15), 100, 8);
                        break;
                    case "RedAlloy":
                        ...
                        GTValues.RA.addBoxingRecipe(GTUtility.copyAmount(1L, new Object[]{stack}), OreDictionaryUnifier.get(OrePrefix.plate, Materials.Paper, 2L), OreDictionaryUnifier.get(OrePrefix.cableGt04, uEntry.material, 1L), 100, 8);
                        GTValues.RA.addUnboxingRecipe(OreDictionaryUnifier.get(OrePrefix.cableGt04, uEntry.material, 1L), GTUtility.copyAmount(1L, new Object[]{stack}), OreDictionaryUnifier.get(OrePrefix.plate, Materials.Paper, 2L), 100, 8);
                        break;
                    default:
                        ...
                        GTValues.RA.addUnboxingRecipe(OreDictionaryUnifier.get(OrePrefix.cableGt04, uEntry.material, 1L), GTUtility.copyAmount(1L, new Object[]{stack}), OreDictionaryUnifier.get(OrePrefix.plate, Materials.Rubber, 2L), 100, 8);
                }
            ...
            case wireGt08:
                switch (uEntry.material.toString()){
                    case "Cobalt": case "Lead": case "Tin": case "Zinc":case "SolderingAlloy":
                        ...
                        GTValues.RA.addBoxingRecipe(GTUtility.copyAmount(1L, new Object[]{stack}), new ItemStack(Blocks.CARPET, 3, 15), OreDictionaryUnifier.get(OrePrefix.cableGt08, uEntry.material, 1L), 100, 8);
                        GTValues.RA.addUnboxingRecipe(OreDictionaryUnifier.get(OrePrefix.cableGt08, uEntry.material, 1L), GTUtility.copyAmount(1L, new Object[]{stack}), new ItemStack(Blocks.CARPET, 3, 15), 100, 8);
                        break;
                    case "RedAlloy":
                        ...
                        GTValues.RA.addBoxingRecipe(GTUtility.copyAmount(1L, new Object[]{stack}), OreDictionaryUnifier.get(OrePrefix.plate, Materials.Paper, 3L), OreDictionaryUnifier.get(OrePrefix.cableGt08, uEntry.material, 1L), 100, 8);
                        GTValues.RA.addUnboxingRecipe(OreDictionaryUnifier.get(OrePrefix.cableGt08, uEntry.material, 1L), GTUtility.copyAmount(1L, new Object[]{stack}), OreDictionaryUnifier.get(OrePrefix.plate, Materials.Paper, 3L), 100, 8);
                        break;
                    default:
                        ...
                        GTValues.RA.addUnboxingRecipe(OreDictionaryUnifier.get(OrePrefix.cableGt08, uEntry.material, 1L), GTUtility.copyAmount(1L, new Object[]{stack}), OreDictionaryUnifier.get(OrePrefix.plate, Materials.Rubber, 3L), 100, 8);
                }
            ...
            case wireGt12:
                switch (uEntry.material.toString()){
                    case "Cobalt": case "Lead": case "Tin": case "Zinc":case "SolderingAlloy":
                        ...
                        GTValues.RA.addBoxingRecipe(GTUtility.copyAmount(1L, new Object[]{stack}), new ItemStack(Blocks.CARPET, 4, 15), OreDictionaryUnifier.get(OrePrefix.cableGt12, uEntry.material, 1L), 100, 8);
                        GTValues.RA.addUnboxingRecipe(OreDictionaryUnifier.get(OrePrefix.cableGt12, uEntry.material, 1L), GTUtility.copyAmount(1L, new Object[]{stack}), new ItemStack(Blocks.CARPET, 4, 15), 100, 8);
                        break;
                    case "RedAlloy":
                        ...
                        GTValues.RA.addBoxingRecipe(GTUtility.copyAmount(1L, new Object[]{stack}), OreDictionaryUnifier.get(OrePrefix.plate, Materials.Paper, 4L), OreDictionaryUnifier.get(OrePrefix.cableGt12, uEntry.material, 1L), 100, 8);
                        GTValues.RA.addUnboxingRecipe(OreDictionaryUnifier.get(OrePrefix.cableGt12, uEntry.material, 1L), GTUtility.copyAmount(1L, new Object[]{stack}), OreDictionaryUnifier.get(OrePrefix.plate, Materials.Paper, 4L), 100, 8);
                        break;
                    default:
                        ...
                        GTValues.RA.addUnboxingRecipe(OreDictionaryUnifier.get(OrePrefix.cableGt12, uEntry.material, 1L), GTUtility.copyAmount(1L, new Object[]{stack}), OreDictionaryUnifier.get(OrePrefix.plate, Materials.Rubber, 4L), 100, 8);
                }
