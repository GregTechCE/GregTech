    ...
    public void registerOre(UnificationEntry uEntry, String modName, SimpleItemStack simpleStack) {
        ...
        if (!uEntry.material.hasFlag(DustMaterial.MatFlags.NO_SMASHING)) {
            RecipeMap.WIREMILL_RECIPES.recipeBuilder()
                    ...
                    .outputs(GTUtility.copy(OreDictionaryUnifier.get(OrePrefix.wireGt01, uEntry.material, 2), GTUtility.copyAmount(1, stack)))
                    .duration(100)
                    .EUt(4)
                    .buildAndRegister();
            RecipeMap.WIREMILL_RECIPES.recipeBuilder()
                    .inputs(OreDictionaryUnifier.get(OrePrefix.stick, uEntry.material, 1))
                    .outputs(GTUtility.copy(OreDictionaryUnifier.get(OrePrefix.wireGt01, uEntry.material, 1), GTUtility.copyAmount(1, stack)))
                    .duration(50)
                    .EUt(4)
                    .buildAndRegister();
        }
