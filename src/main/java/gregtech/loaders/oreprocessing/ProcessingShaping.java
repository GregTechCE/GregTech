        ...
        if (((uEntry.material == Materials.Glass) || (OreDictionaryUnifier.get(OrePrefix.ingot, uEntry.material, 1) != null)) && (!uEntry.material.contains(SubTag.NO_SMELTING))) {
            ...
            if ((tAmount > 0) && (tAmount <= 64) && (uEntry.orePrefix.mMaterialAmount % 3628800L == 0L)) {
                ...
                if (!OrePrefix.block.isIgnored(uEntry.material.mSmeltInto)) {
                    GTValues.RA.addExtruderRecipe(GTUtility.copyAmount(9L, stack), ItemList.Shape_Extruder_Block.get(0L), OreDictionaryUnifier.get(OrePrefix.block, uEntry.material.mSmeltInto, tAmount), 10 * tAmount, 8 * tVoltageMultiplier);
                    GTValues.RA.addAlloySmelterRecipe(GTUtility.copyAmount(9L, stack), ItemList.Shape_Mold_Block.get(0L), OreDictionaryUnifier.get(OrePrefix.block, uEntry.material.mSmeltInto, tAmount), 5 * tAmount, 4 * tVoltageMultiplier);
                }
                if (((uEntry.orePrefix != OrePrefix.ingot) || (uEntry.material != uEntry.material.mSmeltInto))) {
                    GTValues.RA.addExtruderRecipe(GTUtility.copyAmount(1L, stack), ItemList.Shape_Extruder_Ingot.get(0L), OreDictionaryUnifier.get(OrePrefix.ingot, uEntry.material.mSmeltInto, tAmount), 10, 4 * tVoltageMultiplier);
                }

                GTValues.RA.addExtruderRecipe(GTUtility.copyAmount(1L, stack), ItemList.Shape_Extruder_Pipe_Tiny.get(0L), OreDictionaryUnifier.get(OrePrefix.pipeTiny, uEntry.material.mSmeltInto, tAmount * 2), 4 * tAmount, 8 * tVoltageMultiplier);
                if (!(uEntry.material == Materials.Redstone || uEntry.material == Materials.Glowstone)) {
                    GTValues.RA.addExtruderRecipe(GTUtility.copyAmount(1L, stack), ItemList.Shape_Extruder_Pipe_Small.get(0L), OreDictionaryUnifier.get(OrePrefix.pipeSmall, uEntry.material.mSmeltInto, tAmount), 8 * tAmount, 8 * tVoltageMultiplier);
                    GTValues.RA.addExtruderRecipe(GTUtility.copyAmount(3L, stack), ItemList.Shape_Extruder_Pipe_Medium.get(0L), OreDictionaryUnifier.get(OrePrefix.pipeMedium, uEntry.material.mSmeltInto, tAmount), 24 * tAmount, 8 * tVoltageMultiplier);
                    GTValues.RA.addExtruderRecipe(GTUtility.copyAmount(6L, stack), ItemList.Shape_Extruder_Pipe_Large.get(0L), OreDictionaryUnifier.get(OrePrefix.pipeLarge, uEntry.material.mSmeltInto, tAmount), 48 * tAmount, 8 * tVoltageMultiplier);
                }
                GTValues.RA.addExtruderRecipe(GTUtility.copyAmount(12L, stack), ItemList.Shape_Extruder_Pipe_Huge.get(0L), OreDictionaryUnifier.get(OrePrefix.pipeHuge, uEntry.material.mSmeltInto, tAmount), 96 * tAmount, 8 * tVoltageMultiplier);
                GTValues.RA.addExtruderRecipe(GTUtility.copyAmount(1L, stack), ItemList.Shape_Extruder_Plate.get(0L), OreDictionaryUnifier.get(OrePrefix.plate, uEntry.material.mSmeltInto, tAmount), (int) Math.max(materialMass * 1L * tAmount, tAmount), 8 * tVoltageMultiplier);
                if (tAmount * 2 <= 64)
                    GTValues.RA.addExtruderRecipe(GTUtility.copyAmount(1L, stack), ItemList.Shape_Extruder_Rod.get(0L), OreDictionaryUnifier.get(OrePrefix.stick, uEntry.material.mSmeltInto, tAmount * 2), (int) Math.max(materialMass * 2L * tAmount, tAmount), 6 * tVoltageMultiplier);
                if (tAmount * 2 <= 64)
                    GTValues.RA.addExtruderRecipe(GTUtility.copyAmount(1L, stack), ItemList.Shape_Extruder_Wire.get(0L), OreDictionaryUnifier.get(OrePrefix.wireGt01, uEntry.material.mSmeltInto, tAmount * 2), (int) Math.max(materialMass * 2L * tAmount, tAmount), 6 * tVoltageMultiplier);
                if (tAmount * 8 <= 64)
                    GTValues.RA.addExtruderRecipe(GTUtility.copyAmount(1L, stack), ItemList.Shape_Extruder_Bolt.get(0L), OreDictionaryUnifier.get(OrePrefix.bolt, uEntry.material.mSmeltInto, tAmount * 8), (int) Math.max(materialMass * 2L * tAmount, tAmount), 8 * tVoltageMultiplier);
                if (tAmount * 4 <= 64) {
                ...
                GTValues.RA.addExtruderRecipe(GTUtility.copyAmount(1L, stack), ItemList.Shape_Extruder_Shovel.get(0L), OreDictionaryUnifier.get(OrePrefix.toolHeadShovel, uEntry.material.mSmeltInto, tAmount), (int) Math.max(materialMass * 1L * tAmount, tAmount), 8 * tVoltageMultiplier);
                GTValues.RA.addExtruderRecipe(GTUtility.copyAmount(3L, stack), ItemList.Shape_Extruder_Axe.get(0L), OreDictionaryUnifier.get(OrePrefix.toolHeadAxe, uEntry.material.mSmeltInto, tAmount), (int) Math.max(materialMass * 3L * tAmount, tAmount), 8 * tVoltageMultiplier);
                GTValues.RA.addExtruderRecipe(GTUtility.copyAmount(2L, stack), ItemList.Shape_Extruder_Hoe.get(0L), OreDictionaryUnifier.get(OrePrefix.toolHeadHoe, uEntry.material.mSmeltInto, tAmount), (int) Math.max(materialMass * 2L * tAmount, tAmount), 8 * tVoltageMultiplier);
                GTValues.RA.addExtruderRecipe(GTUtility.copyAmount(6L, stack), ItemList.Shape_Extruder_Hammer.get(0L), OreDictionaryUnifier.get(OrePrefix.toolHeadHammer, uEntry.material.mSmeltInto, tAmount), (int) Math.max(materialMass * 6L * tAmount, tAmount), 8 * tVoltageMultiplier);
                GTValues.RA.addExtruderRecipe(GTUtility.copyAmount(2L, stack), ItemList.Shape_Extruder_File.get(0L), OreDictionaryUnifier.get(OrePrefix.toolHeadFile, uEntry.material.mSmeltInto, tAmount), (int) Math.max(materialMass * 2L * tAmount, tAmount), 8 * tVoltageMultiplier);
                GTValues.RA.addExtruderRecipe(GTUtility.copyAmount(2L, stack), ItemList.Shape_Extruder_Saw.get(0L), OreDictionaryUnifier.get(OrePrefix.toolHeadSaw, uEntry.material.mSmeltInto, tAmount), (int) Math.max(materialMass * 2L * tAmount, tAmount), 8 * tVoltageMultiplier);
                GTValues.RA.addExtruderRecipe(GTUtility.copyAmount(4L, stack), ItemList.Shape_Extruder_Gear.get(0L), OreDictionaryUnifier.get(OrePrefix.gearGt, uEntry.material.mSmeltInto, tAmount), (int) Math.max(materialMass * 5L * tAmount, tAmount), 8 * tVoltageMultiplier);

                GTValues.RA.addAlloySmelterRecipe(GTUtility.copyAmount(2L, stack), ItemList.Shape_Mold_Plate.get(0L), OreDictionaryUnifier.get(OrePrefix.plate, uEntry.material.mSmeltInto, tAmount), (int) Math.max(materialMass * 2L * tAmount, tAmount), 2 * tVoltageMultiplier);
                GTValues.RA.addAlloySmelterRecipe(GTUtility.copyAmount(8L, stack), ItemList.Shape_Mold_Gear.get(0L), OreDictionaryUnifier.get(OrePrefix.gearGt, uEntry.material.mSmeltInto, tAmount), (int) Math.max(materialMass * 10L * tAmount, tAmount), 2 * tVoltageMultiplier);
