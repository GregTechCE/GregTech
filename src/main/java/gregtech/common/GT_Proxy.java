...
//                }
    ...
    public Fluid addFluid(String aName, String aLocalized, Material aMaterial, int aState, int aTemperatureK) {
        return addFluid(aName, aLocalized, aMaterial, aState, aTemperatureK, null, null, 0);
    }

    public Fluid addFluid(String aName, String aLocalized, Material aMaterial, int aState, int aTemperatureK, ItemStack aFullContainer,
    ...
    public Fluid addFluid(String aName, String aTexture, String aLocalized, Material aMaterial, short[] aRGBa, int aState, int aTemperatureK,
