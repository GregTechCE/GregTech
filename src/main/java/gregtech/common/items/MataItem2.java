...
public class MataItem2 extends MaterialMetaItem {
    ...
    public MataItem2() {
        ...
        THERMOS_CAN_DARK_COFFEE = addItem(0, "thermoscan.dark.coffee").addStats(new FoodStats(2, 0.2F, true, GregTech_API.sDrinksAlwaysDrinkable, THERMOS_CAN_EMPTY.getStackForm(), new RandomPotionEffect(MobEffects.SPEED, 400, 1, 70), new RandomPotionEffect(MobEffects.HASTE, 400, 1, 70)));
        THERMOS_CAN_DARK_CAFE_AU_LAIT = addItem(1, "thermoscan.dark.cafe.au.lait").setInvisible().addStats(new FoodStats(2, 0.2F, true, GregTech_API.sDrinksAlwaysDrinkable, THERMOS_CAN_EMPTY.getStackForm(), new RandomPotionEffect(MobEffects.SPEED, 400, 2, 90), new RandomPotionEffect(MobEffects.HASTE, 400, 2, 90)));
        THERMOS_CAN_COFFEE = addItem(2, "thermoscan.coffee").addStats(new FoodStats(3, 0.4F, true, GregTech_API.sDrinksAlwaysDrinkable, THERMOS_CAN_EMPTY.getStackForm(), new RandomPotionEffect(MobEffects.SPEED, 400, 0, 50), new RandomPotionEffect(MobEffects.HASTE, 400, 0, 50)));
        THERMOS_CAN_CAFE_AU_LAIT = addItem(3, "thermoscan.cafe.au.lait").addStats(new FoodStats(3, 0.4F, true, GregTech_API.sDrinksAlwaysDrinkable, THERMOS_CAN_EMPTY.getStackForm(), new RandomPotionEffect(MobEffects.SPEED, 400, 1, 70), new RandomPotionEffect(MobEffects.HASTE, 400, 1, 70)));
        THERMOS_CAN_LAIT_AU_CAFE = addItem(4, "thermoscan.lait.au.cafe").setInvisible().addStats(new FoodStats(3, 0.4F, true, GregTech_API.sDrinksAlwaysDrinkable, THERMOS_CAN_EMPTY.getStackForm(), new RandomPotionEffect(MobEffects.SPEED, 400, 2, 90), new RandomPotionEffect(MobEffects.HASTE, 400, 2, 90)));
        THERMOS_CAN_DARK_CHOCOLATE_MILK = addItem(5, "thermoscan.dark.chocolate.milk").addStats(new FoodStats(3, 0.4F, true, GregTech_API.sDrinksAlwaysDrinkable, THERMOS_CAN_EMPTY.getStackForm(), new RandomPotionEffect(MobEffects.REGENERATION, 50, 1, 60)));
        THERMOS_CAN_CHOCOLATE_MILK = addItem(6, "thermoscan.chocolate.milk").addStats(new FoodStats(3, 0.4F, true, GregTech_API.sDrinksAlwaysDrinkable, THERMOS_CAN_EMPTY.getStackForm(), new RandomPotionEffect(MobEffects.REGENERATION, 50, 1, 90)));
        THERMOS_CAN_TEA = addItem(7, "thermoscan.tea").addStats(new FoodStats(2, 0.2F, true, GregTech_API.sDrinksAlwaysDrinkable, THERMOS_CAN_EMPTY.getStackForm(), new RandomPotionEffect(MobEffects.SLOWNESS, 300, 0, 50)));
        THERMOS_CAN_SWEET_TEA = addItem(8, "thermoscan.sweet.tea").setInvisible().addStats(new FoodStats(2, 0.2F, true, GregTech_API.sDrinksAlwaysDrinkable, THERMOS_CAN_EMPTY.getStackForm()));
        THERMOS_CAN_ICE_TEA = addItem(9, "thermoscan.ice.tea").addStats(new FoodStats(2, 0.2F, true, GregTech_API.sDrinksAlwaysDrinkable, THERMOS_CAN_EMPTY.getStackForm(), new RandomPotionEffect(MobEffects.SLOWNESS, 300, 0, 50)));
