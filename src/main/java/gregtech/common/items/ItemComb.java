...
public class ItemComb extends GenericItem {
	...
	public void initCombsRecipes() {
		...
		addSpecialCent(tComb, OreDictionaryUnifier.get(OrePrefixes.gem, Materials.Lignite, 1), 90);
		addProcess(tComb, Materials.Lignite, 100);
		tComb = getStackForType(CombType.COAL);
		addSpecialCent(tComb, OreDictionaryUnifier.get(OrePrefixes.gem, Materials.Coal, 1), 40);
		...
		addSpecialCent(tComb, OreDictionaryUnifier.get(OrePrefixes.dust, Materials.Stone, 1), 70, OreDictionaryUnifier.get(OrePrefixes.dust,Materials.Salt,1),20, OreDictionaryUnifier.get(OrePrefixes.dust,Materials.RockSalt,1),20);
...
//	    // Metals Line
		...
		addSpecialCent(tComb, OreDictionaryUnifier.get(OrePrefixes.dust, Materials.Stone, 1), 50, OreDictionaryUnifier.get(OrePrefixes.dust, Materials.GraniteBlack, 1), 20, OreDictionaryUnifier.get(OrePrefixes.dust, Materials.GraniteRed, 1), 20);
		...
		addSpecialCent(tComb, OreDictionaryUnifier.get(OrePrefixes.dustTiny, Materials.Copper, 1), 70);
		...
		addSpecialCent(tComb, OreDictionaryUnifier.get(OrePrefixes.dustTiny, Materials.Tin, 1), 60);
		addProcess(tComb, Materials.Tin, 100);
		addProcess(tComb, Materials.Cassiterite, 100);
		tComb = getStackForType(CombType.LEAD);
		addSpecialCent(tComb, OreDictionaryUnifier.get(OrePrefixes.dustTiny, Materials.Lead, 1), 45);
		...
		addSpecialCent(tComb, OreDictionaryUnifier.get(OrePrefixes.dustTiny, Materials.Silver, 1), 30);
	...
	public void addProcess(ItemStack tComb, Materials aMaterial, int chance){
		if(GT_Mod.gregtechproxy.mNerfedCombs){
			GT_Values.RA.addChemicalRecipe(GT_Utility.copyAmount(9, tComb), OreDictionaryUnifier.get(OrePrefixes.crushed, aMaterial, 1), Materials.Water.getFluid(1000), aMaterial.mOreByProducts.isEmpty() ? null : aMaterial.mOreByProducts.get(0).getMolten(144), OreDictionaryUnifier.get(OrePrefixes.crushedPurified, aMaterial, 4), 96, 24);
			GT_Values.RA.addAutoclaveRecipe(GT_Utility.copyAmount(16, tComb), Materials.UUMatter.getFluid(Math.max(1, ((aMaterial.getMass()+9)/10))), OreDictionaryUnifier.get(OrePrefixes.crushedPurified, aMaterial, 1), 10000, (int) (aMaterial.getMass() * 128), 384);
		}else{
			GT_Values.RA.addCentrifugeRecipe(tComb, GT_Values.NI, GT_Values.NF, GT_Values.NF, OreDictionaryUnifier.get(OrePrefixes.dustTiny, aMaterial, 1),	ItemList.FR_Wax.get(1, new Object[0]), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, new int[] { chance * 100, 3000 }, 128, 5);
			RecipeManagers.centrifugeManager.addRecipe(40, tComb, ImmutableMap.of(OreDictionaryUnifier.get(OrePrefixes.dustTiny, aMaterial, 1), chance * 0.01f, ItemList.FR_Wax.get(1, new Object[0]), 0.3f));
		}
	}
	
	public void addProcess(ItemStack tComb, Materials aInMaterial, Materials aOutMaterial, int chance){
		if(GT_Mod.gregtechproxy.mNerfedCombs){
			GT_Values.RA.addChemicalRecipe(GT_Utility.copyAmount(9, tComb), OreDictionaryUnifier.get(OrePrefixes.crushed, aInMaterial, 1), Materials.Water.getFluid(1000), aInMaterial.mOreByProducts.isEmpty() ? null : aInMaterial.mOreByProducts.get(0).getMolten(144), OreDictionaryUnifier.get(OrePrefixes.crushedPurified, aOutMaterial, 4), 96, 24);
			GT_Values.RA.addAutoclaveRecipe(GT_Utility.copyAmount(16, tComb), Materials.UUMatter.getFluid(Math.max(1, ((aOutMaterial.getMass()+9)/10))), OreDictionaryUnifier.get(OrePrefixes.crushedPurified, aOutMaterial, 1), 10000, (int) (aOutMaterial.getMass() * 128), 384);
		}else{
			GT_Values.RA.addCentrifugeRecipe(tComb, GT_Values.NI, GT_Values.NF, GT_Values.NF, OreDictionaryUnifier.get(OrePrefixes.dustTiny, aOutMaterial, 1),	ItemList.FR_Wax.get(1, new Object[0]), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, new int[] { chance * 100, 3000 }, 128, 5);
			RecipeManagers.centrifugeManager.addRecipe(40, tComb, ImmutableMap.of(OreDictionaryUnifier.get(OrePrefixes.dustTiny, aOutMaterial, 1), chance * 0.01f, ItemList.FR_Wax.get(1, new Object[0]), 0.3f));
		}
	}
