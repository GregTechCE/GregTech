...
public class ItemComb extends GenericItem {
	...
	public void initCombsRecipes() {
		...
		addSpecialCent(tComb, OreDictionaryUnifier.get(OrePrefix.gem, Materials.Lignite, 1), 90);
		addProcess(tComb, Materials.Lignite, 100);
		tComb = getStackForType(CombType.COAL);
		addSpecialCent(tComb, OreDictionaryUnifier.get(OrePrefix.gem, Materials.Coal, 1), 40);
		...
		addSpecialCent(tComb, OreDictionaryUnifier.get(OrePrefix.dust, Materials.Stone, 1), 70, OreDictionaryUnifier.get(OrePrefix.dust,Materials.Salt,1),20, OreDictionaryUnifier.get(OrePrefix.dust,Materials.RockSalt,1),20);
...
//	    // Metals Line
		...
		addSpecialCent(tComb, OreDictionaryUnifier.get(OrePrefix.dust, Materials.Stone, 1), 50, OreDictionaryUnifier.get(OrePrefix.dust, Materials.GraniteBlack, 1), 20, OreDictionaryUnifier.get(OrePrefix.dust, Materials.GraniteRed, 1), 20);
		...
		addSpecialCent(tComb, OreDictionaryUnifier.get(OrePrefix.dustTiny, Materials.Copper, 1), 70);
		...
		addSpecialCent(tComb, OreDictionaryUnifier.get(OrePrefix.dustTiny, Materials.Tin, 1), 60);
		addProcess(tComb, Materials.Tin, 100);
		addProcess(tComb, Materials.Cassiterite, 100);
		tComb = getStackForType(CombType.LEAD);
		addSpecialCent(tComb, OreDictionaryUnifier.get(OrePrefix.dustTiny, Materials.Lead, 1), 45);
		...
		addSpecialCent(tComb, OreDictionaryUnifier.get(OrePrefix.dustTiny, Materials.Silver, 1), 30);
