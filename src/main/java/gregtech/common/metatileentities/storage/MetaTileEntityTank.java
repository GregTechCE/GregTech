...
public class MetaTileEntityTank extends MetaTileEntity {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        tooltip.add(I18n.format("gregtech.universal.tooltip.fluid_storage_capacity", String.format("%,d", tankSize)));
        ...
        if (tagCompound != null && tagCompound.hasKey("Fluid", NBT.TAG_COMPOUND)) {
            ...
            tooltip.add(I18n.format("gregtech.machine.fluid_tank.fluid",
            		String.format("%,d", fluidStack.amount), I18n.format(fluidStack.getUnlocalizedName())));
        }
    }
