...
public class SteamCompressor extends SteamMetaTileEntity {
    ...
    public SteamCompressor(String metaTileEntityId, boolean isHighPressure) {
        super(metaTileEntityId, RecipeMap.COMPRESSOR_RECIPES, Textures.COMPRESSOR_OVERLAY, isHighPressure);
    }
