...
public class SteamExtractor extends SteamMetaTileEntity {
    ...
    public SteamExtractor(String metaTileEntityId, boolean isHighPressure) {
        super(metaTileEntityId, RecipeMap.EXTRACTOR_RECIPES, Textures.EXTRACTOR_OVERLAY, isHighPressure);
    }
    ...
    public ModularUI<IUIHolder> createUI(EntityPlayer player) {
        return createUITemplate(player)
            ...
            .widget(102, new ProgressWidget<>(workableHandler::getProgressPercent, 78, 24, 20, 18)
