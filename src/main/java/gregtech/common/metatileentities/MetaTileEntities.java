...
public class MetaTileEntities {
    ...
    public static void init() {
        ...
        CENTRIFUGE[3] = GregTechAPI.registerMetaTileEntity(153, new SimpleMachineMetaTileEntity("centrifuge.ev", RecipeMaps.CENTRIFUGE_RECIPES, Textures.CENTRIFUGE_OVERLAY, 4));
        ...
        CRACKER = GregTechAPI.registerMetaTileEntity(525, new MetaTileEntityCrackingUnit("cracker"));
