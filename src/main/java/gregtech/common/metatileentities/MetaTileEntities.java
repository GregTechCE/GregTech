...
//        GTLog.logger.info("Registering TileEntities.");
        ...
        GregTechAPI.METATILEENTITY_REGISTRY.register(6, "steam_alloy_smelter", new WorkableMetaTileEntityFactory<>(BlockMachine.ToolClass.WRENCH, 1, new String[]{"Furnace++"}, SteamAlloySmelter.class, new GTResourceLocation("steam_alloy_smelter"), 1, RecipeMap.ALLOY_SMELTER_RECIPES));
