...
//        GTLog.logger.info("Registering TileEntities.");
        ...
        //TODO: Make these descriptions better, please
        GregTechAPI.METATILEENTITY_REGISTRY.register(1, "electric_furnace", new WorkableMetaTileEntityFactory<>(BlockMachine.ToolClass.WRENCH, 1, new String[0], TestMTE.class, new GTResourceLocation("mte_test"), 1, RecipeMap.FURNACE_RECIPES));
