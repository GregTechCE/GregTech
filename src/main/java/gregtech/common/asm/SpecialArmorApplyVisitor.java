...
public class SpecialArmorApplyVisitor extends MethodVisitor {

    public static final String TARGET_CLASS_NAME = "net/minecraftforge/common/ISpecialArmor$ArmorProperties";
    public static final String TARGET_METHOD_NAME = "applyArmor(Lnet/minecraft/entity/EntityLivingBase;Lnet/minecraft/util/NonNullList;Lnet/minecraft/util/DamageSource;D)F";

    private static final String METHOD_OWNER = "net/minecraft/util/CombatRules";
    private static final String METHOD_DESC = "(FFF)F";
    private static final String METHOD_NAME_MCP = "getDamageAfterAbsorb";
    private static final String METHOD_NAME_SRG = "func_189427_a";
    ...
    private boolean checkTargetInsn(int opcode, String owner, String name, String desc) {
        return opcode == Opcodes.INVOKESTATIC &&
            owner.equals(METHOD_OWNER) && desc.equals(METHOD_DESC) &&
            (name.equals(METHOD_NAME_MCP) || name.equals(METHOD_NAME_SRG));
    }
