...
public class GT_MetaTileEntity_OilCracker extends GT_MetaTileEntity_MultiBlockBase {
    ...
    public boolean checkRecipe(ItemStack aStack) {
        ...
        for (FluidStack tInput : tInputList) {
            ...
            GT_Recipe tRecipe = GT_Recipe.GT_Recipe_Map.sCrakingRecipes.findRecipe(getBaseMetaTileEntity(), false, GT_Values.V[tTier], new FluidStack[]{tInput}, new ItemStack[]{});
            if (tRecipe != null) {
