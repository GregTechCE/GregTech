...
public class GTRecipeWrapper implements IRecipeWrapper {
    ...
    public void drawInfo(Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
        minecraft.fontRenderer.drawString(I18n.format("gregtech.recipe.total", recipe.getEUt() * recipeMap.getAmperage() * recipe.getDuration()), 30, 60, 0x111111);
        minecraft.fontRenderer.drawString(I18n.format("gregtech.recipe.eu", recipe.getEUt()), 30, 70, 0x111111);
        minecraft.fontRenderer.drawString(I18n.format("gregtech.recipe.duration", recipe.getDuration() / 20f), 30, 80, 0x111111);
        minecraft.fontRenderer.drawString(I18n.format("gregtech.recipe.amperage", recipeMap.getAmperage()), 30, 90, 0x111111);
    }
}
